            ...
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/hry.jpg" alt="movie-card"
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/titanuc.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/6.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
                <ul class="genres-list p-0 mb-2 d-flex align-items-center flex-wrap list-inline">
                  <li class="fw-semi-bold">
                    <a href="./assets/images/genre/5.jpg" tabindex="0" class="font-size-14 ">
                      Action </a>
                  </li>
                </ul>
                <div class="cart-content">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/5.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/8.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/b.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/c.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/d.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/e.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assets/images/genre/f.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
