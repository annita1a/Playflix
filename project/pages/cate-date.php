                ...
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/n.jpg" alt="movie-card"
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/o.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/p.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/q.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/r.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/s.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/aa.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/bb.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/cc.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/dd.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/ee.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assets/images/genre/ff.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
