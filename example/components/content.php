        ...
        <div class="content-inner container-fluid pb-0" id="page_layout">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between gap-3 flex-wrap align-items-center top-rated-slider">
                        ...
                        <div class="card-body">
                            <div class="swiper overflow-hidden" data-swiper="top-slider">
                                            ...
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="./dashboard/assets/images/dashboard/01.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-01">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i class="ph ph-eye fs-5 me-1"></i>134</p>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="./dashboard/assets/images/dashboard/02.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-02">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i class="ph ph-eye fs-5 me-1"></i>133</p>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="./dashboard/assets/images/dashboard/03.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-03">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <p class="mb-0 mt-2">Movie</p>
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i class="ph ph-eye fs-5 me-1"></i>222</p>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="./dashboard/assets/images/dashboard/04.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-04">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    ...
                                                    <p class="mb-0 mt-2">T.V Show</p>
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i class="ph ph-eye fs-5 me-1"></i>122</p>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="./dashboard/assets/images/dashboard/05.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-05">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
                                                    <h6 class="font-weight-600 mb-0">Last
                                                    ...
                                                    <p class="mb-0 mt-2">T.V Show</p>
                                                    <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                                        <p class="mb-0 me-2"><i class="ph ph-eye fs-5 me-1"></i>144</p>
                                    ...
                                    <li class="iq-rated-box swiper-slide">
                                        <div class="iq-card mb-0">
                                            <div class="iq-card-body p-0">
                                                <div class="iq-thumb">
                                                    <a href="javascript:void(0)">
                                                        <img src="./dashboard/assets/images/dashboard/06.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-06">
                                                    </a>
                                                </div>
                                                <div class="iq-feature-list mt-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="streamit-wraper-table2">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between gap-3 flex-wrap align-items-center mb-4 gap-2">
                                <div class="card-title">
                                    <h4 class="mb-0 responsive-item-font">Recently Viewed Items</h4>
                                </div>
                                <div class="card-header-toolbar d-flex align-items-center seasons">
                                    <div class="iq-custom-select d-inline-block ">
                                        <select name="cars" class="form-select season-select">
                            ...
                            <div class="card-body">
                                <div class="table-view table-space">
                                    <table id="seasonTable" class="data-tables table custom-table movie_table data-table-one"
                                        style="width:100%" data-toggle="data-table1">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="iq-movie">
                                                            <a href="javascript:void(0);"><img src="./dashboard/assets/images/movie-thumb/rabbit.webp"
                                                                    class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-01"></a>
                                                        </div>
                                                        <div class="text-start ms-3">
                                                            <p class="mb-0">Rabbit</p>
                                                            <small></small>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="iq-movie">
                                                            <a href="javascript:void(0);"><img src="./dashboard/assets/images/movie-thumb/joker.webp"
                                                                    class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-02"></a>
                                                        </div>
                                                        <div class="text-start ms-3">
                                                            <p class="mb-0">joker</p>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="iq-movie">
                                                            <a href="javascript:void(0);"><img src="./dashboard/assets/images/movie-thumb/war-for-the-planet.webp"
                                                                    class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-03"></a>
                                                        </div>
                                                        <div class="text-start ms-3">
                                                            <p class="mb-0">War For The Planet</p>
                                                            <small></small>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="iq-movie">
                                                            <a href="javascript:void(0);"><img src="./dashboard/assets/images/movie-thumb/krishna.webp"
                                                                    class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-04"></a>
                                                        </div>
                                                        <div class="text-start ms-3">
                                                            <p class="mb-0">Krishna</p>
                                                            <small></small>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="iq-movie">
                                                            <a href="javascript:void(0);"><img src="./dashboard/assets/images/movie-thumb/the-hunter.webp"
                                                                    class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-05"></a>
                                                        </div>
                                                        <div class="text-start ms-3">
                                                            <p class="mb-0">The Hunter</p>
                                                            <small></small>
                                                        </div>
                                                    </div>
                                                </td>
