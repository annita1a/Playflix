...
<head>
  ...
  <link rel="stylesheet" href="./assets/frontend/css/core/libs.min.css" />
  ...
  <link rel="stylesheet" href="./frontend/assets/css/streamit.min.css?v=5.4.0" />
  
  <!-- Custom Css -->
  <link rel="stylesheet" href="./frontend/assets/css/custom.min.css?v=5.4.0" />
  
  <!-- Rtl Css -->
  <link rel="stylesheet" href="./frontend/assets/css/rtl.min.css?v=5.4.0" />
  ...
  <!-- Phosphor icons  -->
  <link rel="stylesheet" href="./frontend/assets/vendor/phosphor-icons/Fonts/regular/style.css">
  <link rel="stylesheet" href="./frontend/assets/vendor/phosphor-icons/Fonts/duotone/style.css">
  
  <link rel="stylesheet" href="./frontend/assets/vendor/phosphor-icons/Fonts/fill/style.css">
  
  
  <link rel="stylesheet" href="./frontend/assets/vendor/streamit-font/iconly.css"></head>
        ...
        <div class="row justify-content-center align-items-center height-self-center vh-100">
            <div class="col-lg-5 col-md-12 align-self-center">
                <div class="user-login-card rounded-3">
                    <a href="./index.html">
                        <img class="img-fluid logo" src="./frontend/assets/images/logo.png" alt="#">
                    </a>
                    <div class="sign-in-page-data">
                        <div class="sign-in-from w-100 m-auto">
                           <form action="proses_login.php" method="POST">
                                ...
                                <!-- <div class="mb-3">
                                    <label for="exampleInputEmail1" class="mb-2 custom-form-label">
                                        Username or Email Address </label>
                                    <input placeholder="Enter email" autocomplete="off" required type="email"
                                        id="exampleInputEmail1" class="mb-0 form-control" />
                                </div> -->
...
<?php endif; ?>
                                ...
                                <div class="mb-3">
    <label class="mb-2 custom-form-label">Username</label>
    <input type="text"
           name="username"
           placeholder="Enter username"
           autocomplete="off"
           class="mb-0 form-control <?php echo isset($_SESSION['error']['username']) ? 'is-invalid' : ''; ?>">
    <div class="invalid-feedback">
        <?php echo $_SESSION['error']['username'] ?? ''; ?>
                                ...
                                <div class="mb-3">
                                    <!-- <label for="exampleInputPassword2" class="mb-2 custom-form-label">
                                        Password </label>
                                    <div class="input-group custom-input-group mb-3">
                                        <input placeholder="Password" required type="password"
                                            id="exampleInputPassword2" class="mb-0 form-control">
                                        <span class="input-group-text"><i class="ph ph-eye-slash"
                                                id="togglePassword"></i></span>
                                    </div> -->
                                    <div class="mb-3">
    <label class="mb-2 custom-form-label">Password</label>
    <div class="input-group custom-input-group mb-3">
        <input type="password"
               name="password"
               placeholder="Password"
               class="mb-0 form-control <?php echo isset($_SESSION['error']['password']) ? 'is-invalid' : ''; ?>">
    ...
    <span class="button-text">Login</span>
                                ...
                                <div class="css_prefix-social-login-section text-center">No apps configured. Please
