   ...
   <div class="overflow-hidden pt-5">
      <div class="suggested-block section-wraper">
         <div class="d-flex align-items-center justify-content-between px-1 mb-2 pb-1 mb-md-4 pb-md-0">
            <h4 class="main-title text-capitalize mb-0 fw-medium">Recommendation</h4>
         </div>
...
<div class="section-padding view-all-movies">
  <div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4">
            <h4 class="main-title text-capitalize mb-0">Series based of you interests</h4>
        </div>
...
<div class="section-padding view-all-movies">
  <div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="main-title text-capitalize mb-0">History</h4>
    </div>
