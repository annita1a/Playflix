...
<div class="section-padding view-all-movies">
  <div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4">
            <h4 class="main-title text-capitalize mb-0"> Popular Movies</h4>
        </div>
          ...
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/hry.jpg" alt="movie-card"
              ...
              <div class="card-description with-transition">
                  ...
                  <div class="content-left">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <div class="d-flex align-items-center gap-1">
                        ...
                        <small class="font-size-12">2:59</small>
                      </div>
                ...
                <div class="d-flex align-items-center justify-content-center gap-2 mt-3">
                  ...
                  <div class="iq-play-button iq-button">
                    <a href="./" class="btn btn-primary w-100">Play Now
                    </a>
                  </div>
                </div>
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/titanuc.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
                ...
                <div class="cart-content">
                  <div class="content-left">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <div class="d-flex align-items-center gap-1">
                        <i class="ph ph-clock font-size-12"></i>
                        <small class="font-size-12">2:30</small>
                      </div>
                      <div class="d-flex align-items-center gap-2">
                        <i class="ph ph-translate"></i>
                        <small class="font-size-12">English (UK)</small>
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/6.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
                <ul class="genres-list p-0 mb-2 d-flex align-items-center flex-wrap list-inline">
                  <li class="fw-semi-bold">
                    <a href="./assetsx/images/genre/5.jpg" tabindex="0" class="font-size-14 ">
                      Action </a>
                  </li>
                </ul>
                <div class="cart-content">
                  <div class="content-left">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <div class="d-flex align-items-center gap-1">
                        <i class="ph ph-clock font-size-12"></i>
                        <small class="font-size-12">2:03</small>
                      </div>
                      <div class="d-flex align-items-center gap-2">
                        <i class="ph ph-translate"></i>
                        <small class="font-size-12">English (UK)</small>
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/5.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/8.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
                ...
                <div class="cart-content">
                  <div class="content-left">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <div class="d-flex align-items-center gap-1">
                        <i class="ph ph-clock font-size-12"></i>
                        <small class="font-size-12">2:04</small>
                      </div>
                      <div class="d-flex align-items-center gap-2">
                        <i class="ph ph-translate"></i>
                        <small class="font-size-12">English (UK)</small>
...
<div class="section-padding view-all-movies">
  <div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4">
            <h4 class="main-title text-capitalize mb-0"> Recommended Movies</h4>
        </div>
    <div class="card-style-grid">
      <div class="row gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 data-listing">
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/b.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/c.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/d.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/e.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/genre/f.jpg" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
        ...
        <div class="col hidden-tags" style="display: none;">
          <div class="iq-card card-hover">
            <div class="block-images position-relative w-100">
              <div class="img-box w-100">
                <a href="./" class="position-relative top-0 bottom-0 start-0 end-0">
                  <img src="./assetsx/images/media/dinoosaur-portrait.webp" alt="movie-card"
                    class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                </a>
              </div>
              <div class="card-description with-transition">
