  ...
  <div class="overflow-hidden">
    <div class="recommended-block section-padding-top">
      <div class="d-flex align-items-center justify-content-between px-1 mb-2 pb-1 mb-md-4 pb-md-0">
        <h4 class="main-title text-capitalize mb-0">2024 Releases</h4>
      </div>
                ...
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/n.jpg" alt="movie-card"
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/o.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/p.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/q.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/r.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/s.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
    ...
    <div class="related-movie-block">
      <div class="d-flex align-items-center justify-content-between px-1 mb-2 pb-1 mb-md-4 pb-md-0">
        <h4 class="main-title text-capitalize mb-0">Coming Soon</h4>
      </div>
      <div class="card-style-slider">
        <div class="position-relative swiper swiper-card" data-slide="6" data-laptop="6" data-tab="3" data-mobile="2"
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/aa.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/bb.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/cc.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/dd.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/ee.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
            ...
            <li class="swiper-slide">
              <div class="iq-card card-hover">
                <div class="block-images position-relative w-100">
                  <div class="img-box w-100">
                    <a href="./movie-detail.html" class="position-relative top-0 bottom-0 start-0 end-0">
                      <img src="./assetsx/images/genre/ff.jpg" alt="movie-card"
                        class="img-fluid object-cover w-100 d-block border-0 rounded-3">
                    </a>
                  </div>
                  <div class="card-description with-transition">
