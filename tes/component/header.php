                ...
                <nav id="navbar_main"
                    ...
                    <div class="container-fluid p-lg-0">
                        ...
                        <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link "
                                    href="dashboard.php?page=home"> Home </a>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse  list-unstyled border rounded-3" id="features">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            href="dashboard.php?page=genre"> Genre </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            href="dashboard.php?page=film"> Film </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link " href="dashboard.php?page=series"> Series
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link " href="dashboard.php?page=releasedata"> Release Date </a>
                                    </li>
                    ...
                    <ul
                        ...
                        <li class="nav-item dropdown iq-responsive-menu d-xl-block d-none">
                            <div class="search-box">
                                <a href="#" class="nav-link p-0 text-white" id="search-drop" data-bs-toggle="dropdown">
                        ...
                        <li class="nav-item">
                            <a class="nav-link shoping-cart-button text-white" href="javascript:void(0);" data-bs-toggle="offcanvas"
    ...
    <div class="offcanvas-footer border-top py-3 px-3">
        ...
        <div class="mini-cart-buttons d-flex flex-column align-items-center gap-3 mt-4">
            <div class="iq-button w-100">
                <a href="./shop/checkout.html" class="btn btn-primary text-capitalize w-100 rounded-3">
