                ...
                <div class="css_prefix-card">
                  <div class="block-images position-relative w-100">
                    <div class="image-box w-100">
                      <a href="#">
                        <img :src="generateImgPath('assets/images/media/vikings.webp')" alt="Vikings"
                ...
                <div class="ratting-card">
                  ...
                  <b-row class="align-items-center g-3">
                    ...
                    <b-col xl="7" lg="8" md="7" sm="9" cols="7">
                      <div class="progress w-100 progress-ratings" role="progressbar" aria-label="Rating 5"
                  ...
                  <b-row class="align-items-center g-3">
                    ...
                    <b-col xl="7" lg="8" md="7" sm="9" cols="7">
                      <div class="progress w-100 progress-ratings" role="progressbar" aria-label="Rating 4"
                  ...
                  <b-row class="align-items-center g-3">
                    ...
                    <b-col xl="7" lg="8" md="7" sm="9" cols="7">
                      <div class="progress w-100 progress-ratings" role="progressbar" aria-label="Rating 3"
                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar bg-success" style="width: 25%"></div>
                      </div>
                    </b-col>
                  ...
                  <b-row class="align-items-center g-3">
                    ...
                    <b-col xl="7" lg="8" md="7" sm="9" cols="7">
                      <div class="progress w-100 progress-ratings" role="progressbar" aria-label="Rating 2"
                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar bg-success" style="width: 25%"></div>
                      </div>
                    </b-col>
                  ...
                  <b-row class="align-items-center g-3">
                    ...
                    <b-col xl="7" lg="8" md="7" sm="9" cols="7">
                      <div class="progress w-100 progress-ratings" role="progressbar" aria-label="Rating 1"
                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar bg-success" style="width: 25%"></div>
                      </div>
                    </b-col>
                ...
                <div class="review-detail rounded-3">
                  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div class="d-flex align-items-center justify-content-center gap-3">
                      <img :src="generateImgPath(review.avatar)" class="img-fluid user-img rounded-circle"
                        :alt="review.author" />
                      <div>
                    ...
                    <div class="star-rating d-flex gap-1 align-items-center">
                      <i v-for="i in 5" :key="i" class="ph-fill ph-star"
                        :class="i <= review.rating ? 'text-warning' : ''"></i>
                    </div>
                  </div>
