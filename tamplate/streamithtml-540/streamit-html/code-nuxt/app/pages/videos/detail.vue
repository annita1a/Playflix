    ...
    <div class="movie-detail-part position-relative">
      <div class="trending-info pt-0 pb-0">
        <div class="details-parts">
          <MovieDescription movie-name="streamMovies.minions" :video-url="{ name: 'videos-player' }"
            movie-duration="50mins" movie-released="Feb 2017" view-number="84" :movie-views="$t('streamKeyword.views')"
            :is-video-page-data="true" movie-language="English (New Zealand)" :is-notimdb-rating="true" />
        </div>
      </div>
    </div>
  </div>
  ...
  <b-container fluid>
    <div class="overflow-hidden">
      <section class="upcomimg-block section-padding-top">
        <UpcomingMovies :title="$t('sectionTitle.upcoming')" :list="upcomingVideoDatail" :notview-all-btn="true">
        </UpcomingMovies>
      </section>
...
import { upcomingVideoDatail } from '~/StaticData/data';
...
const playerOption = ref({
  ...
  fullscreen: true,
  poster: '/assets/images/media/minions-4.webp',
});
</script>
