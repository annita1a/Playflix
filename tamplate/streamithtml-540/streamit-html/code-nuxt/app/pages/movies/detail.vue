    ...
    <div class="movie-detail-part position-relative">
      <div class="trending-info pt-0 pb-0">
        <div class="details-parts">
          <MovieDescription movie-name="streamMovies.game_of_heros" :video-url="{name: 'movies-player'}" movie-type="NC-17" movie-duration="2hr : 6mins"
            movie-released="2021" view-number="284" :movie-views="$t('streamKeyword.views')" imdb-rating="7"
            movie-language="English" movie-description></MovieDescription>
        </div>
      </div>
    </div>
  </div>
  ...
  <b-container fluid>
    <div class="overflow-hidden">
      ...
      <section class="recommended-block section-padding-top">
        <MoviesRecommendedForYou :title="$t('sectionTitle.recommended')" :list="RecommendedDownloaded" :slides-per-view="6" :loop="false">
      ...
      <section class="related-movie-block">
        <MoviesRecommendedForYou :title="('sectionTitle.recommended_movie')" :list="RecommendedDownloadedMovie" :slides-per-view="6" :loop="false">
        </MoviesRecommendedForYou>
      ...
      <div class="related-product-block related-product-slider">
        <section class="overflow-hidden">
          ...
          <div class="card-style-slider">
            <Swiper :dir="rtl" tag="ul" :slides-per-view="6" :space-between="20" :loop="false" :autoplay="false"
              ...
              <SwiperSlide v-for="product in products" :key="product.id" tag="li">
                <ProductCard v-bind="product"
                  :shop-title="product.shopTitle && product.shopTitle.startsWith('streamShop.') ? $t(product.shopTitle) : product.shopTitle" />
              </SwiperSlide>
