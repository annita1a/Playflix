          ...
          <form class="checkout-coupon">
            ...
            <div class="iq-checkout-coupon">
              <input name="coupon-code" type="text" required="required" :placeholder="$t('streamShop.coupon_code')"
                class="form-control" />
              <div class="mt-4">
                <CustomButton class="btn btn-primary text-capitalize position-relative rounded-3"
                  :button-text="$t('streamButtons.apply_coupon')" />
              </div>
            </div>
          </form>
        </div>
      ...
      <b-row>
        <b-col lg="6">
          <form action="#">
            ...
            <div class="form-group">
              <label for="first-name" class="form-label">{{ $t('streamAccount.city_region') }} <span
                  class="text-primary">*</span></label>
              <select ref="selectElement" class="form-control" :tabindex="tabindex">
                <option selected>{{ $t('streamShop.country_india') }}</option>
            ...
            <div class="form-group">
              <label for="street-address" class="form-label">{{ $t('streamAccount.street_address') }} <span
                  class="text-primary">*</span></label>
              <input name="billing-address" type="text" required="required" :placeholder="$t('streamAccount.billing_address')"
                class="form-control mb-2" />
              <input name="billing-address2" type="text" required="required" :placeholder="$t('streamAccount.apartment')"
                class="form-control" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="email-address" class="form-label">{{ $t('streamAccount.email_address') }} <span
                  class="text-primary">*</span></label>
              <input name="billing-company" type="email" required="required" placeholder=""
        ...
        <b-col lg="6">
          ...
          <div class="mb-4">
            ...
            <textarea name="your-message" :placeholder="$t('streamShop.order_notes_eg')" class="form-control mb-5"
              required=""></textarea>
          </div>
        </b-col>
      </b-row>
        ...
        <div class="order_review-box">
          ...
          <div v-for="data in myCart" :key="data" class="checkout-review-order">
            <div class="table-responsive mb-0">
              <checkout-card :thumbnail="data.thumbnail" :slug="data.slug" :product-name="data.product_name"
              ...
              <div class="checkout-payment mt-4">
                <div class="payment-box border-bottom mb-4 pt-4 p-3">
                  <div id="accordionPayment" class="accordion">
                    <div class="accordion-item-payment">
                      ...
                      <b-collapse id="collapseOnepayment" class="accordion-collapse collapse show"
                    ...
                    <div class="accordion-item-payment">
                      ...
                      <b-collapse id="collapseTwopayment" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-item-payment">
                      ...
                      <b-collapse id="collapseThreepayment" class="accordion-collapse collapse"
                ...
                <p class="mb-3 p-3 pb-0">
                  ...
                  <nuxt-link :to="{ name: 'extra-privacy-policy' }" class="final text-primary">
                    {{ $t('sectionTitle.privacy_policy') }}
                  </nuxt-link>
                </p>
                <div class="text-end pb-3 pe-3">
                  <div class="iq-button">
                    <nuxt-link :to="{ name: 'merchandise-track-order' }"
