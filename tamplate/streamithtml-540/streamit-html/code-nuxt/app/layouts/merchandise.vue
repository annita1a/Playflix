<template>
  ...
  <div id="offcanvasCart" class="offcanvas offcanvas-end sidebar-cart border-0 on-rtl end" tabindex="-1"
    aria-modal="true" role="dialog">
    <div class="offcanvas-header py-4">
      <h5 class="offcanvas-title">{{ $t("streamShop.shopping_cart") }} (3)</h5>
      ...
      <div class="sidebar-cart-content d-flex flex-column justify-content-between">
              ...
              <div class="cart-item-block d-flex gap-3">
                ...
                <div class="cart-block-content position-relative flex-grow-1 pe-5">
                  ...
                  <div class="position-absolute top-0 end-0">
                    <a href="javascript:void();" class="text-white delete-btn text-capitalize"> {{ $t("streamSweetalert.delete_btn") }}</a>
                  </div>
                </div>
              </div>
            </li>
        ...
        <div class="cart-progress-container mt-5 pt-5 border-top">
          <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
            <h5 class="m-0 fw-bold">{{ $t("streamShop.subtotal") }}</h5>
            <h5 class="m-0 fw-bold">$49.00</h5>
          </div>
          <div class="d-grid gap-3 mt-4">
            <nuxt-link to="/merchandise/checkout" class="btn bg-primary text-uppercase fw-medium w-100 text-white">
              <span class="button-text small">{{ $t("streamShop.checkout") }}</span>
            </nuxt-link>

            <nuxt-link to="/merchandise/cart" class="btn bg-light text-uppercase fw-medium w-100 text-dark">
              <span class="button-text small">{{ $t("streamButtons.view_cart") }}</span>
            </nuxt-link>
          </div>
        </div>
      </div>
