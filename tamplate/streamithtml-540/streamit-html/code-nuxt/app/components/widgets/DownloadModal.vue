<template>
  <div id="downloadModal" class="modal fade view-more-data-modal downloadModal" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered share-modal">
      <div class="modal-content">
        <div class="modal-header">
          <h5 id="exampleModalLabeldownload" class="modal-title">{{$t('streamMovies.download_quality')}}</h5>
