<template>
  <div v-if="!isProductList" class="product-block">
    ...
    <div class="image-wrap">
      ...
      <div class="buttons-holder">
        <ul class="list-unstyled m-0 p-0">
          ...
          <li>
            <nuxt-link to="#" class="add_to_wishlist wishlist-btn border-0 rounded-3" @click="wishlistSwal">
              <i class="ph ph-heart fs-5"></i>
            </nuxt-link>
          </li>
          <li>
            <nuxt-link to="#" class="added_to_cart cart-btn d-flex align-items-center" @click="cartSwal">
    ...
    <div class="product-caption">
      <nuxt-link :to="{ name: 'merchandise-product-detail' }" class="title-link text-primary">
        {{ $t(props.productName) }}
      </nuxt-link>
      ...
      <b-col xl="3" md="4">
        ...
        <div class="image-wrap">
          ...
          <div class="buttons-holder">
            <ul class="list-unstyled m-0 p-0">
              <li>
                <nuxt-link class="cursor-pointer" to="#" data-bs-toggle="modal" data-bs-target="#woosq-popup">
                  <i class="ph ph-eye"></i>
                </nuxt-link>
              </li>
            </ul>
      ...
      <b-col md="8">
        <div class="product-caption">
          <h4 class="product__title mb-2">
            <nuxt-link :to="{ name: 'merchandise-product-detail' }" class="title-link">
              {{ $t(props.productName) }}
            </nuxt-link>
          </h4>
          <div class="price-detail">
          ...
          <ul class="iq-button-holder list-inline d-flex align-items-center flex-wrap gap-3">
            <li>
              <div>
                <nuxt-link to="#" class="btn btn-primary cart-btn position-relative rounded-3" @click="cartSwal">
