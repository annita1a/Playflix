    ...
    >
      ...
      <li class="nav-item" role="presentation">
        <a
          ...
          tabindex="-1"
        >
          {{ $t("streamShop.rate") }} &amp; {{ $t("streamShop.reviews") }}
        </a>
      </li>
      <li class="nav-item" role="presentation">
        <a
    ...
    <div class="tab-content">
      ...
      >
        <div class="description-content">
          <p>
            {{ $t("streamMovies.zombie_island_desc") }}
          </p>
        </div>
      </div>
      ...
      <div id="source-01" class="tab-pane animated fadeInUp" role="tabpanel">
        <div class="source-list-content table-responsive">
          <table class="table custom-table">
            <thead>
              <tr>
                <th>{{ $t("sectionTitle.links") }}</th>
                <th>{{ $t("sectionTitle.quality") }}</th>
                <th>{{ $t("language.language") }}</th>
                <th>{{ $t("streamKeyword.player") }}</th>
            ...
            <tbody>
              <tr>
                ...
                <td>{{ $t("streamKeyword.musicbee") }}</td>
                <td>2021-11-28</td>
              </tr>
              <tr>
                <td>
                ...
                <td>800p</td>
                <td>{{ $t("language.eng") }}</td>
                <td>5{{ $t("streamKeyword.k_player") }}</td>
                <td>2021-11-25</td>
              </tr>
              <tr>
                <td>
