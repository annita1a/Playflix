    ...
    <div class="profile-box">
      <b-container fluid>
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
          ...
          <CustomButton button-title="Subscription" :link="{ name: 'landing-page.pricing-plan' }"></CustomButton>
        </div>
      </b-container>
    </div>
    <div class="tabs">
        ...
        <div class="content-details iq-custom-tab-style-two">
          <b-tabs class="trending-custom-tab" content-class="px-0" pills nav-class="d-flex justify-content-center nav nav-pills tab-header">
            <b-tab :title="$t('streamPages.playlist')" active>
              ...
              <create-playlist buttonname="streamPlaylist.create_playlist"></create-playlist>
            </b-tab>
            <b-tab :title="$t('streamAccount.watchlist')">
              <div class="overflow-hidden animate__animated animate__fadeInUp">
                <div class="d-flex align-items-center justify-content-between my-4">
              ...
              <create-playlist buttonname="streamSweetalert.create_watchlist"></create-playlist>
            </b-tab>
