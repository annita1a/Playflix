        ...
        <b-col xl="9" sm="12">
          <div class="d-flex align-items-center justify-content-between shop-filter flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center">
              <div class="product-view-button rounded">
                <ul id="pills-tab" class="nav_shop nav d-flex nav-pills mb-0 iq-product-filter d-flex gap-2 bg-transparent align-items-center list-inline" role="tablist">
              ...
              <div class="iq-custom-select d-inline-block shop-select rounded-3">
                <select ref="selectElement" class="form-control select2-basic-multiple" :tabindex="tabindex">
                  ...
                  <option value="season6">{{ $t('streamShop.price_high_to_low') }}</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div id="pills-tabContent" class="tab-content">
            ...
            <div id="pills-list-view" class="tab-pane fade" role="tabpanel" aria-labelledby="list-view-tab">
              <b-row class="row-cols-1">
                <b-col v-for="data in listProduct" :key="data.id">
                  <ProductCard :is-product-list="true" :product-img="data.thumbnail" :shop-title="$t(data.product_name)" :shop-sale="data.is_sale" :bg-shop="data.bgShop" :shop-del="data.shopDel" :shop-price="data.price" :rating="data.rating" :shop-desc="$t(data.shopDesc)" />
                </b-col>
              </b-row>
            </div>
            ...
            <div id="pills-grid-view" class="tab-pane fade" role="tabpanel" aria-labelledby="grid-view-tab">
              <b-row class="row-col-data gy-5 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-2">
                <b-col v-for="data in productShop" :key="data.id">
          ...
          <div class="pe-3">
              ...
              <ul class="list-unstyled p-0 m-0 shop-list-checkbox">
                ...
                <li>
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="form-check d-block">
                      ...
                      <label class="form-check-label" for="flexCheckDefault3"> {{$t('streamShop.disney_world')}} </label>
                    </div>
                    <a class="" data-bs-toggle="collapse" href="#categoriesone" role="button" aria-expanded="false" aria-controls="categoriesone">
                    ...
                    <ul class="list-unstyled ps-2 mt-3">
                      <li>
                        <div class="form-check d-block">
                          ...
                          <label class="form-check-label" for="flexCheckDefault4"> {{$t('streamShop.fantasia')}} </label>
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                <li>
                  <div class="form-check d-block">
                    ...
                    <label class="form-check-label" for="flexCheckDefault5"> {{$t('streamShop.galaxy_heaven')}} </label>
                  </div>
                </li>
                <li>
                  <div class="form-check d-block">
                    <input id="flexCheckDefault6" class="form-check-input" type="checkbox" value="" />
                    <label class="form-check-label" for="flexCheckDefault6"> {{$t('streamShop.haunted_halloween')}} </label>
                  </div>
                </li>
                <li>
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="form-check d-block">
                      ...
                      <label class="form-check-label" for="flexCheckDefault7"> {{$t('streamShop.marvel_studios')}} </label>
                    </div>
                    <a class="" data-bs-toggle="collapse" href="#categoriestwo" role="button" aria-expanded="false" aria-controls="categoriesone">
                      <i class="ph ph-caret-down align-middle"></i>
                    </a>
                  </div>
                    ...
                    <ul class="list-unstyled ps-2 mt-3">
                      <li>
                        <div class="form-check d-block">
                          ...
                          <label class="form-check-label" for="flexCheckDefault8"> {{$t('streamShop.avengers')}} </label>
                        </div>
                      </li>
                      <li>
                        <div class="form-check d-block">
                ...
                <li>
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="form-check d-block">
                      ...
                      <label class="form-check-label" for="flexCheckDefault10"> {{$t('streamShop.monster_house')}} </label>
                    </div>
                    <a class="" data-bs-toggle="collapse" href="#categoriesthree" role="button" aria-expanded="false" aria-controls="categoriesone">
                      <i class="ph ph-caret-down align-middle"></i>
                    </a>
                  </div>
                    ...
                    <ul class="list-unstyled ps-2 mt-3">
                      <li>
                        <div class="form-check d-block">
                          ...
                          <label class="form-check-label" for="flexCheckDefault11"> {{$t('streamShop.ghost_spider')}} </label>
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                <li>
                  <div class="form-check d-block">
                    ...
                    <label class="form-check-label" for="flexCheckDefault12"> {{$t('streamShop.monster_house')}} </label>
                  </div>
                </li>
                <li>
                  <div class="form-check d-block">
            ...
            <div class="shop-box">
              ...
              <ul class="iq-blog-meta-cat-tag iq-blogtag p-0 m-0 list-unstyled gap-2 widget_tags widget-tags-product">
                <li>
                  <router-link to="/blogs-tag" class="position-relative">{{$t('streamShopTag.camera')}}</router-link>
                </li>
                <li>
                  <router-link to="/blogs-tag" class="position-relative">{{$t('streamShopTag.costume')}}</router-link>
                </li>
                <li>
                  <router-link to="/blogs-tag" class="position-relative">{{$t('streamShopTag.lighting')}}</router-link>
                </li>
                <li>
                  <router-link to="/blogs-tag" class="position-relative">{{$t('streamShopTag.production')}}</router-link>
                </li>
                <li>
                  <router-link to="/blogs-tag" class="position-relative">{{$t('streamShopTag.studios')}}</router-link>
                </li>
              </ul>
            </div>
            <div class="shop-box">
            ...
            <div class="shop-box border-bottom-0">
              ...
              <ul v-for="data in newProduct" :key="data" class="list-unstyled m-0 p-0 shop-product">
                <ShopCategorySidebar :thumbnail="data.thumbnail" :product-name="data.product_name" :price="data.price" :final-price="data.final_price" :ratting="data.ratting" :additional-info="data.additional_info" />
              </ul>
            </div>
          </div>
        </b-col>
