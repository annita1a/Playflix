                    ...
                    <b-col xxl="3" xl="4" lg="5">
                        <div class="card border-0">
                            <div
                                ...
                                <h5 class="m-0">{{ $t('streamPlaylist.playlist_movie_90s_throwback') }}</h5>
                                <small>
                                    1/4 </small>
                            </div>
                                ...
                                <div class="playlist-data">
                                    <div class="playlist-data-card active">
                                        <div class="playlist-data-card-image">
                                            <a href="#">
                                                <img :src="generateImgPath('assets/images/media/gameofhero.webp')" alt="Game of Heros"
                                    ...
                                    <div class="playlist-data-card ">
                                        <div class="playlist-data-card-image">
                                            <a href="#">
                                                <img :src="generateImgPath('assets/images/media/rabbit.webp')" alt="Rabbit"
                                                    class="img-fluid object-cover w-100 border-0">
                                            </a>
                                        </div>
                                        <div class="playlist-data-card-content">
                                    ...
                                    <div class="playlist-data-card ">
                                        <div class="playlist-data-card-image">
                                            <a href="#">
                                                <img :src="generateImgPath('/assets/images/media/migration.webp')" alt="Migration"
                                                    class="img-fluid object-cover w-100 border-0">
                                            </a>
                                        </div>
                                        <div class="playlist-data-card-content">
                                    ...
                                    <div class="playlist-data-card ">
                                        <div class="playlist-data-card-image">
                                            <a href="#">
                                                <img :src="generateImgPath('assets/images/media/joker.webp')" alt="joker"
                                                    class="img-fluid object-cover w-100 border-0">
                                            </a>
                                        </div>
                                        <div class="playlist-data-card-content">
                            ...
                            <ul class="actions-playlist list-inline my-2 p-0 d-flex gap-2 justify-content-md-end">
                                    ...
                                    <button id="like-toggle" type="button" class="btn btn-secondary border action-btn"
                                        ...
                                        <span id="like-movies">
                                            <span class="h-100 w-100 d-block" data-bs-toggle="tooltip"
                                                ...
                                                :data-bs-title="$t(isLiked ? 'streamTooltip.un-like' : 'streamTooltip.like')">
                                ...
                                <li class="position-relative share-button dropend dropdown">
                                    <button type="button" class="btn btn-secondary border action-btn"
                                        ...
                                        <span class="h-100 w-100 d-block" data-bs-toggle="tooltip"
                                            data-bs-placement="top" :data-bs-title="$t('streamTooltip.share')">
