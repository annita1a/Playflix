<template>
                ...
                <div id="pmpro_order_single-meta">
                    <ul class="pmpro_list pmpro_list-plain pmpro_list-with-labels pmpro_cols-2">
                        <li id="pmpro_order_single-meta-order_date" class="pmpro_list_item">
                            <span class="pmpro_list_item_label">{{ $t('streamProfile.order_date_label') }}</span>
                            {{ order.date }}
                        </li>
                        <li id="pmpro_order_single-meta-payment_method" class="pmpro_list_item">
                            <span class="pmpro_list_item_label">{{ $t('streamShop.payment_method') }}</span>
                            {{ order.paymentMethod }}
                        </li>
                            ...
                            <tbody>
                                <tr>
                                    <th data-title="Description">
                                        {{ t('streamProfile.table_description_account') }}  (marvin@demo.com)
                                    </th>
    ...
    <div class="pmpro_actions_nav">
        <span class="pmpro_actions_nav-right">
            <router-link
                :to="{ path: '/membership-account' }">{{ $t('streamProfile.nav_view_membership_account') }}</router-link>
        </span>
        <span class="pmpro_actions_nav-left">
            <router-link :to="{ path: '/membership-orders' }">{{ $t('streamProfile.nav_view_all_orders') }}</router-link>
        </span>
    </div>
</template>
