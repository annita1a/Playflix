        ...
        <div class="product-block inner-box">
          <div class="product-block">
            ...
            <div class="image-wrap">
              <img :src="props.thumbnail" class="img-fluid w-100 img-zoom" alt="img" loading="lazy" />
            </div>
          </div>
        </div>
      </b-col>
        ...
        <div class="summary ms-lg-4">
          ...
          <div class="comment-form-rating ratestar">
            <div class="star">
              ...
              <span><i class="ph-fill ph-star"></i></span>
              <span><i class="ph-fill ph-star"></i></span>
              <span class="text-primary">1 {{ $t('streamShop.reviews') }}</span>
            </div>
          </div>
          <p class="price">
...
v-for="categories in props.category" :key="categories"
          ...
          <div class="">
            {{ $t("streamPages.tags") }} :<router-link
            ...
            <div class="description-content">
              <table class="addtable mb-5">
                <tbody>
                  ...
                  <tr>
                    <th class="thwidth">{{ $t("streamShop.color") }}</th>
                    <td class="bordertd">
                      <span v-for="data in props.additionalInfo" :key="data" to="#" rel="color">
          ...
          <div id="review-24" class="tab-pane fade" role="tabpanel">
            <div id="reviews" class="streamit-reviews">
              <div id="comments" class="comments-area validate-form">
                ...
                <p class="masvideos-noreviews mt-3">{{ $t("streamReview.no_reviews") }}.</p>
              </div>
              <div id="review_form_wrapper">
                <div id="review_form">
                  <div id="respond" class="comment-respond">
                    <p id="reply-title" class="comment-reply-title mt-0 mb-0">
                      {{ $t("streamReview.first_review") }} “{{ props.productName
                      }}”</p>
                    <form class="comment-form">
                      <p class="comment-notes">
                        <span id="email-notes">{{ $t("streamShop.published_email") }}.</span>
                        <span class="required-field-message" aria-hidden="true">{{
                          $t("streamShop.required_fields") }} <span class="required" aria-hidden="true">*</span></span>
                      </p>
                      <div class="comment-form-rating ratestar">
                        <label for="rating">{{ ("streamShop.your_rating") }}*</label>
                        <div class="star">
                      ...
                      <p class="comment-form-comment p-0 mb-3 mt-0">
                        <label for="comment">{{ $t("streamShop.your_review") }}&nbsp;<span
                            class="required">*</span></label><textarea
id="comment" name="comment" cols="45" rows="8"
                          required=""></textarea>
                      </p>
                      <p class="comment-form-author mt-3 pe-lg-12 pe-0 namefull">
                        <label for="author">{{ $t("streamAccount.name") }}&nbsp;<span class="required">*</span></label>
                        <input id="author" name="author" type="text" value="" size="30" required="" />
                      </p>
                      <p class="comment-form-email mt-3 ps-lg-12 pe-0 namefull">
                        <label for="email">{{ $t("streamAccount.email") }}&nbsp;<span class="required">*</span></label>
                        <input id="email" name="email" type="email" value="" size="30" required="" />
                      </p>
                      <p class="comment-form-cookies-consent">
                        <input id="check11" class="form-check-input" type="checkbox" name="check1" />
                        <label class="form-check-label" for="check11"> {{ $t("streamAccount.save_name") }}. </label>
                      </p>
                      <p class="form-submit">
                        <button
