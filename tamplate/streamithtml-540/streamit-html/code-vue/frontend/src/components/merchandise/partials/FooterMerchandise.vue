        ...
        <b-row>
          <b-col sm="6" lg="4">
            <div class="footer-inner">
              <p class="text-uppercase letter-spacing-1 font-size-14 mb-1">{{ $t('streamAccount.customer_services') }}
              </p>
              <h4 class="mb-0 contact text-white fw-bold"><a href="tel:+4805550103">+ (480) 555-0103</a></h4>
              <span class="d-inline-block mt-4 mb-0 font-size-14">{{ $t('streamAccount.email_us') }} <a
          ...
          <b-col lg="4" sm="6" class="mt-sm-0 mt-5">
            <div class="footer-inner position-relative text-center px-xl-5 px-3">
              ...
              <p class="mt-lg-5 mt-4 mb-3 text-uppercase letter-spacing-1 font-size-14 mb-1">{{
                $t('streamAccount.best_deals') }}</p>
              <div class="mailchimp mailchimp-dark">
                <div class="input-group mb-3 mt-4">
                  <input type="text" class="form-control mb-0 font-size-14"
                    :placeholder="$t('streamAccount.email') + ' *'" aria-describedby="button-addon2" />
                  <div class="iq-button">
                    <button id="button-addon2" type="submit"
                      class="btn btn-primary st-subscribe-btn text-uppercase">{{ $t('streamButtons.subscribe') }}</button>
                  </div>
                </div>
                <span class="d-inline-block font-size-14">* {{ $t("streamAccount.email_anyone") }}</span>
              </div>
              ...
              <b-row>
                <b-col lg="6">
                  <ul class="list-unstyled footer-menu mb-0">
                    <li class="mb-2">
                      <router-link :to="{ name: 'landing-page.contact-us' }" class="ms-3">{{
                        $t('streamPages.contact_us') }}</router-link>
                    </li>
                    <li>
                      <router-link :to="{ name: 'landing-page.privacy-policy' }" class="ms-3">{{
                        $t('streamPages.privacy_policy') }}</router-link>
                    </li>
                  </ul>
                </b-col>
                <b-col lg="6" class="mt-lg-0 mt-2">
                  <ul class="list-unstyled footer-menu mb-0">
                    <li>
                      <router-link :to="{ name: 'landing-page.terms-of-use' }" class="ms-3">{{
                        $t('sectionTitle.terms_of_use') }}</router-link>
                    </li>
                  </ul>
                </b-col>
              </b-row>
      ...
      <b-container fluid>
        <b-row class="align-items-center">
          <b-col md="6" class="text-md-start text-center">
            <p class="m-0 font-size-14 text-capitalize">© <span class="currentYear">2025 </span><router-link
                :to="{ name: 'landing-page.ott' }">STREAMIT</router-link> {{
                  $t('stream_terms_of_uses.all_right_reserved') }}</p>
          </b-col>
          <b-col md="6" class="text-md-end text-center">
            <p class="m-0 font-size-14">{{ $t('stream_terms_of_uses.powered_by') }} <a href="https://iqonic.design/"
                target="_blank">IQONIC DESIGN</a></p>
          </b-col>
        </b-row>
      </b-container>
    </div>
