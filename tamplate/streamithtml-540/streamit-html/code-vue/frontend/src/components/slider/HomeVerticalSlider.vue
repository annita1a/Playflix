<template>
  <div class="verticle-slider section-padding-bottom sdf">
    <!-- <b-container fluid> -->
    <div class="slider">
      <div class="slider-flex position-relative">
        <div class="slider--col position-relative">
          <div class="vertical-slider-prev swiper-button"><i class="ph ph-caret-up"></i></div>
          <div class="slider-thumbs" data-swiper="slider-thumbs">
            <div class="swiper-container" data-swiper="slider-thumbs-inner">
              <swiper
              v-if="render" :dir="rtl" :loop="true" :slides-per-view="3" :space-between="24" :navigation="{
                nextEl: '.vertical-slider-next',
                prevEl: '.vertical-slider-prev',
              }" :modules="modules" class="swiper-wrapper top-ten-slider-nav" :direction="'vertical'"
                ...
                <SwiperSlide v-for="data in thumbsSwiperCard" :key="data.title" tag="li" class="swiper-slide swiper-bg">
                  <div class="block-images position-relative">
                    <div class="img-box slider--image">
                      <img :src="data.image" class="img-fluid" alt="img" loading="lazy" />
                    </div>
          ...
          <div class="vertical-slider-next swiper-button"><i class="ph ph-caret-down"></i></div>
        </div>
        <div class="slider-images" data-swiper="slider-images">
          <div class="swiper-container" data-swiper="slider-images-inner">
            <swiper
v-if="render" :dir="rtl" :loop="true" :space-between="10" :free-mode="true"
              :watch-slides-progress="true" :modules="modules" :direction="'vertical'" class="swiper-container"
              ...
              <SwiperSlide v-for="data in sliderData" :key="data" tag="li" class="swiper-slide">
                ...
                <div class="description">
                  <div class="block-description">
                    ...
                    <p class="mt-0 mb-3">{{ $t(data.description) }}</p>
