  ...
  <div ref="slider" :class="props.cardStyleSlider ? null : 'card-style-slider'">
    <div :class="`${props.classlist}`">
          <div :class="`${props.classCustom}`">
            <div v-if="notviewAllBtn" :class="`d-flex align-items-center justify-content-between ${props.marginPadding}`">
              <h4 class="main-title text-capitalize mb-0 fw-medium">{{ props.title }}</h4>
            </div>
            <div v-else :class="`d-flex align-items-center justify-content-between ${props.marginPadding}`">
              <h4 class="main-title text-capitalize mb-0 fw-medium">{{ props.title }}</h4>
...
const props = defineProps({
  ...
  notviewAllBtn: { type: Boolean, default: false },
