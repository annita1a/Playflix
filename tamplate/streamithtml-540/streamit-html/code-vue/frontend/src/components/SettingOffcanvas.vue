<template>
  <div class="rtl-box">
    <a id="settingbutton" class="btn btn-icon btn-setting" :class="themeSchemeDirection !== 'ltr' ? 'start' : 'end'"
    ...
    <nav id="live-customizer" class="offcanvas live-customizer"
      ...
      <div class="offcanvas-header justify-content-between gap-1">
        <div class="d-flex align-items-center">
          <h5 id="live-customizer-label" class="offcanvas-title text-dark">{{ $t('streamSetting.live_customizer') }}
          </h5>
        </div>
        <div class="d-flex gap-1 align-items-center">
          <button class="btn btn-icon text-primary" data-reset="settings" data-bs-toggle="tooltip"
            data-bs-placement="left" aria-label="Reset All Settings" data-bs-original-title="{t 'streamSetting.reset_all_settings'}"
            @click="store.reset_state()">
      ...
      <div class="offcanvas-body pt-0">
        ...
        <div class="modes mt-3">
          <div class="color-customizer mb-3">
            <h6 class="mb-0 title-customizer">{{ $t('streamSetting.color_customizer') }}</h6>
          </div>
          <b-row class="row-cols-2 gx-2">
            <b-col class="mb-3">
