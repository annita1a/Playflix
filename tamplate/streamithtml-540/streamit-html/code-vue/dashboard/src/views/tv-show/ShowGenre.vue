        ...
        <b-card-body>
          <form>
            <div class="form-group">
              <InputField id="genre-name" :label="$t('addpage.genre-name')" type="text" :placeholder="$t('addpage.enter-title-genre')" :is-required="true" />
            </div>
            <div class="form-group">
              <InputField id="genre-slug" :label="$t('addpage.genre-slug')" type="text" :placeholder="$t('addpage.enter-slug-genre')" :is-required="true" />
            </div>
            ...
            <div class="form-group">
              <label class="form-label">{{$t('addpage.genre-description')}}</label>
      ...
      <b-card no-body>
        <div class="pb-3">
          <b-card-header class="d-flex justify-content-between align-items-center">
            <h2 class="episode-playlist-title wp-heading-inline">
              <span class="position-relative"> {{$t('addpage.tvshow-genre')}} </span>
            </h2>
          </b-card-header>
          <b-card-body>
...
const columns = ref([
  ...
  { data: 'parentCategory', title: 'Parent Genre' },
  {
    data: null,
    title: 'Count',
    render: function (row) {
