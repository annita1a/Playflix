            ...
            <table class="table table-striped mb-0">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/01.jpg" alt="img" loading="lazy" />
                  ...
                  <td>
                    <div class="d-flex gap-2 align-items-center">
                      <a v-b-tooltip="{ title: 'View' }" class="btn btn-sm btn-soft-warning rounded" href="#"><i class="fa-solid fa-eye"></i></a>
                      <a v-b-tooltip="{ title: 'Edit' }" class="btn btn-sm btn-soft-success rounded" href="#"><i class="fa-solid fa-pen"></i></a>
                      <a v-b-tooltip="{ title: 'Delete' }" class="btn btn-sm btn-soft-danger rounded" href="#"><i class="fa-solid fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/02.jpg" alt="img" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/03.jpg" alt="img" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/04.jpg" alt="img" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/05.jpg" alt="img" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/06.jpg" alt="img" loading="lazy" />
                      <div class="media-support-info">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/07.jpg" alt="img" loading="lazy" />
                      <div class="media-support-info">
                        <h5 class="iq-sub-label">Anne Teak</h5>
                        <p class="mb-0">@musk</p>
                      </div>
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img class="rounded img-fluid avatar-60 me-3" src="/assets/images/user/08.jpg" alt="img" loading="lazy" />
                      <div class="media-support-info">
                        <h5 class="iq-sub-label">Anne Teak</h5>
                        <p class="mb-0">@musk</p>
                      </div>
