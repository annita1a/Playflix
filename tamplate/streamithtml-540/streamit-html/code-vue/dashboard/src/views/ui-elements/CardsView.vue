<template>
  ...
  <b-row>
    ...
    <b-col sm="4">
      <b-card no-body class="bg-dark text-white mb-3">
        <img src="/assets/images/page-img/07.jpg" class="card-img" alt="#" loading="lazy" />
  ...
  <b-row>
    ...
    <b-col lg="4">
      <b-card no-body class="text-white bg-primary mb-3">
        <b-card-body>
    ...
    <b-col lg="4">
      <b-card no-body class="mb-3 text-white bg-secondary">
        <b-card-body>
    ...
    <b-col lg="4">
      <b-card no-body class="mb-3 text-white bg-success">
        <b-card-body>
    ...
    <b-col lg="4">
      <b-card no-body class="mb-3 text-white bg-danger">
        <b-card-body>
    ...
    <b-col lg="4">
      <b-card no-body class="mb-3 text-white bg-warning">
        <b-card-body>
    ...
    <b-col lg="4">
      <b-card no-body class="mb-3 text-white bg-info">
        <b-card-body>
  ...
  <b-row>
    ...
    <b-col lg="4">
      <b-card no-body class="mb-3 border-primary">
    ...
    <b-col lg="4">
      <b-card no-body class="mb-3 border-secondary">
        <b-card-body class="text-secondary">
          <b-card-title class="text-secondary">Primary card title</b-card-title>
          <p class="card-text">Some quick example text to build on the card title text to build on the card title and make up the bulk of the card's content.</p>
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="4">
      <b-card no-body class="mb-3 border-success">
        <b-card-body class="text-success">
          <b-card-title class="text-success">Primary card title</b-card-title>
          <p class="card-text">Some quick example text to build on the card title text to build on the card title and make up the bulk of the card's content.</p>
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="4">
      <b-card no-body class="mb-3 border-danger">
        <b-card-body class="text-danger">
          <b-card-title class="text-danger">Primary card title</b-card-title>
          <p class="card-text">Some quick example text to build on the card title text to build on the card title and make up the bulk of the card's content.</p>
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="4">
      <b-card no-body class="mb-3 border-warning">
        <b-card-body class="text-warning">
          <b-card-title class="text-warning">Primary card title</b-card-title>
          <p class="card-text">Some quick example text to build on the card title text to build on the card title and make up the bulk of the card's content.</p>
        </b-card-body>
      </b-card>
    </b-col>
    <b-col lg="4">
      <b-card no-body class="mb-3 border-info">
        <b-card-body text-info>
          <b-card-title class="text-info">Primary card title</b-card-title>
          <p class="card-text text-info">Some quick example text to build on the card title text to build on the card title and make up the bulk of the card's content.</p>
        </b-card-body>
      </b-card>
    </b-col>
  </b-row>
  ...
  <b-col sm="12">
    ...
    <b-row data-masonry='{"percentPosition": true }'>
      ...
      <b-col sm="12" lg="4">
        <b-card no-body class="bg-primary text-white text-center mb-3">
          <blockquote class="blockquote mb-0 card-body">
            <p class="font-size-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
            <footer class="blockquote-footer">
      ...
      <b-col sm="12" lg="4">
        <b-card no-body class="text-center mb-3">
          <b-card-body>
            <b-card-title>Card title</b-card-title>
      ...
      <b-col sm="12" lg="4">
        <b-card no-body class="text-right mb-3">
