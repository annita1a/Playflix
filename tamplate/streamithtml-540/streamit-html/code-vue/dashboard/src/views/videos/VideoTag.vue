<template>
  <b-row class="streamit-wraper-table2">
      ...
      <b-card no-body>
        <b-card-header>
          <h2 class="episode-playlist-title wp-heading-inline">
            <span class="position-relative"> {{$t('addpage.add-new-video-tag')}} </span>
          </h2>
        </b-card-header>
        <b-card-body>
          <form>
            ...
            <div class="d-flex align-items-center justify-content-end mt-4">
              <button class="btn btn-primary custom-add-button">{{$t('addpage.add-video-tag')}}</button>
            </div>
          </form>
        </b-card-body>
      </b-card>
    ...
    <b-col lg="8">
      <b-card no-body>
        <div class="pb-3">
          <b-card-header class="d-flex justify-content-between align-items-center">
            <h2 class="episode-playlist-title wp-heading-inline">
              <span class="position-relative"> {{$t('sidebar.video-tags')}} </span>
            </h2>
          </b-card-header>
          <b-card-body>
      ...
      <b-offcanvas v-model="offcanvasEnd1" class="offcanvas-width-80" footer-hide header-close-class="me-0" :placement="themeSchemeDirection !== 'ltr' ? 'start' : 'end'">
        <template #header>
          <h2 class="episode-playlist-title wp-heading-inline">
            <span class="position-relative"> {{$t('addpage.update-video-tag')}} </span>
          </h2>
...
const tableData = ref([
  { title: 'Universe', slug: 'universe', count: '1' },
  { title: 'Thriller', slug: 'Thriller', count: '1' },
  { title: 'Romance', slug: 'Romance', count: '3' },
  { title: 'Melodrama', slug: 'Melodrama', count: '1' },
  { title: 'Magic', slug: 'Magic', count: '1' },
  { title: 'Horror', slug: 'horror', count: '0' },
  { title: 'Fantasy', slug: 'fantasy', count: '0' },
  { title: 'Family', slug: 'family', count: '0' },
  { title: 'Drama', slug: 'drama', count: '1' },
  { title: 'Dragons', slug: 'dragons', count: '3' },
]);
