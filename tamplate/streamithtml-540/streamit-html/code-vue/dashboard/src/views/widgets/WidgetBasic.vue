      ...
      <b-col lg="6">
        <b-card>
          <div class="border-bottom text-center pb-3">
            ...
            <img src="/assets/images/avatars/03.png" alt="User-Profile" class="theme-color-purple-img img-fluid avatar-80 mb-4" loading="lazy" />
            <img src="/assets/images/avatars/02.png" alt="User-Profile" class="theme-color-blue-img img-fluid avatar-80 mb-4" loading="lazy" />
            <img src="/assets/images/avatars/04.png" alt="User-Profile" class="theme-color-green-img img-fluid avatar-80 mb-4" loading="lazy" />
            <img src="/assets/images/avatars/05.png" alt="User-Profile" class="theme-color-yellow-img img-fluid avatar-80 mb-4" loading="lazy" />
            <img src="/assets/images/avatars/06.png" alt="User-Profile" class="theme-color-pink-img img-fluid avatar-80 mb-4" loading="lazy" />
            <div>
