      ...
      <b-col lg="3">
        <b-card no-body>
          <b-card-body>
            ...
            <div class="text-center">
              <h2><Vue3Autocounter ref="counter" :start-amount="0" :end-amount="65" />M</h2>
              <div>
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" clip-rule="evenodd" />
      ...
      <b-col lg="3">
        <b-card no-body>
          <b-card-body>
            ...
            <div class="text-center">
              <h2><Vue3Autocounter ref="counter" :start-amount="0" :end-amount="96.6" :duration="3" decimal-separator="." :decimals="1" />K</h2>
              <div>
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" clip-rule="evenodd" />
      ...
      <b-col lg="3">
        <b-card no-body>
          <b-card-body>
            ...
            <div class="text-center">
              <h2><Vue3Autocounter ref="counter" :start-amount="0" :end-amount="15.5" :duration="3" decimal-separator="." :decimals="1" />K</h2>
              <div>
        ...
        <b-card>
          ...
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
              ...
              <h2>$ <Vue3Autocounter ref="counter" :start-amount="0" :end-amount="37" />K</h2>
            </div>
            <div class="pt-3">
        ...
        <b-card>
          ...
          <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
              ...
              <h2><Vue3Autocounter ref="counter" :start-amount="0" :end-amount="32" />%</h2>
            </div>
            <div class="pt-3">
        ...
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            <div class="service-data">
              <h3><Vue3Autocounter ref="counter" :start-amount="0" :end-amount="24" />%</h3>
        ...
        <b-card>
          <div class="d-flex flex-column">
            ...
            <div class="border rounded">
              <apexchart height="250" type="bar" :series="extrachart.series" :options="extrachart.options" :color-opt="true" />
            </div>
          </div>
        </b-card>
      </b-col>
