  ...
  <b-row class="streamit-wraper-table2">
      ...
      <b-card no-body>
        <b-card-header>
          <h2 class="episode-playlist-title wp-heading-inline">
            <span class="position-relative"> {{$t('addpage.add_new_genre')}} </span>
          </h2>
        </b-card-header>
        <b-card-body>
          <form>
            <div class="form-group">
              <InputField id="genre-name" :label="$t('addpage.name')" type="text" :placeholder="$t('addpage.enter-title-genre')" :is-required="true" />
            </div>
            <div class="form-group">
              <InputField id="genre-slug" :label="$t('addpage.slug')" type="text" :placeholder="$t('addpage.enter-slug-genre')" :is-required="true" />
            </div>

            <div class="form-group">
              <label class="form-label" for="parent-genre">{{$t('addpage.parent-genre')}}</label>
            ...
            <div class="d-flex align-items-center justify-content-end mt-4">
              <button class="btn btn-primary custom-add-button">{{$t('addpage.add-genre')}}</button>
            </div>
          </form>
        </b-card-body>
      </b-card>
    ...
    <b-col lg="8">
      <div class="card">
        <div class="pb-3">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h2 class="episode-playlist-title wp-heading-inline">
              <span class="position-relative"> {{$t('addpage.genres')}} </span>
            </h2>
          </div>
          <div class="card-body">
      ...
      <b-offcanvas v-model="offcanvasEnd1" class="offcanvas-width-80" header-close-class="me-0" :placement="themeSchemeDirection !== 'ltr' ? 'start' : 'end'">
        <template #header>
          <h2 class="episode-playlist-title wp-heading-inline">
            <span class="position-relative"> {{$t('addpage.update_genre')}} </span>
          </h2>
        ...
        <b-form class="custom-from-section-bottom">
          <div class="form-group">
            <InputField id="genre-name" :label="$t('addpage.name')" :model-value="$t('addpage.name')" type="text" :placeholder="$t('addpage.enter-title-genre')" :is-required="true" />
          </div>
          <div class="form-group">
            <InputField id="genre-slug" :label="$t('addpage.slug')" :model-value="$t('addpage.genremovie')" type="text" :placeholder="$t('addpage.enter-slug-genre')" :is-required="true" />
          </div>

          <div class="form-group">
            <label class="form-label" for="parent-genre1">{{$t('addpage.parent-genre')}}</label>
            <select id="parent-genre1" ref="addStatus1" class="form-control select2-basic-multiple" :tabindex="tabindexaddStatus1">
              <option>Add Parent Genre</option>
              <option>Action</option>
              <option>Adventure</option>
              <option>Animation</option>
          ...
          <div class="form-group">
            <label class="form-label">{{$t('addpage.description')}}</label>
            <textarea class="form-control large-text" :placeholder="$t('addpage.genres')" aria-label="With textarea"></textarea>
          </div>
        </b-form>
        <template #footer>
...
const tableData = ref([
  { movie: '/assets/images/genres/romance.webp', title: 'Romance', slug: 'romance', parentCategory: '0', count: '2' },
  { movie: '/assets/images/genres/mystery.webp', title: 'Mystery', slug: 'mystery', parentCategory: '0', count: '14' },
  { movie: '/assets/images/genres/horror.webp', title: 'Horror', slug: 'horror', parentCategory: '0', count: '13' },
  { movie: '/assets/images/genres/Crime.webp', title: 'Crime', slug: 'crime', parentCategory: '0', count: '10' },
  { movie: '/assets/images/genres/animation.webp', title: 'Animation', slug: 'animation', parentCategory: '0', count: '10' },
  { movie: '/assets/images/genres/adventure.webp', title: 'Adventure', slug: 'adventure', parentCategory: '0', count: '18' },
  { movie: '/assets/images/genres/action.webp', title: 'Action', slug: 'action', parentCategory: '0', count: '22' },
]);
