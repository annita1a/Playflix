...
export const useSetting = defineStore('setting', {
  ...
  actions: {
    ...
    theme_scheme_direction(payload) {
      ...
      document.documentElement.setAttribute('dir', this.setting.theme_scheme_direction.value)
      document.querySelector('html').setAttribute('dir', this.setting.theme_scheme_direction.value)
      updateStorage(this.saveLocal, this.storeKey, createSettingObj(this))
    },
