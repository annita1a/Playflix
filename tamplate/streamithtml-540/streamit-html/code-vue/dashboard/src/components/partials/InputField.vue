<template>
  <div class="form-group">
    ...
    <!-- textarea input -->
    <textarea
v-if="type == 'textarea'" :id="label" class="form-control" :rows="rows" :value="modelValue"
      :placeholder="placeholder" @input="updateModelValue"></textarea>
    ...
    <flat-pickr v-else-if="type == 'date'" v-model="date" class="form-control flatpickr-input"
      :placeholder="placeholder" />

    <!-- simple input -->
    <input
v-else :id="label" :type="type" :class="`form-control ${className}`" :value="modelValue"
      :placeholder="placeholder" :min="min" :multiple="isMulti" @input="updateModelValue" />
