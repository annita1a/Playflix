...
import Detail_Descrition_Modal from "./detailpage_modal/detail_description_model";

interface Props {
  title: string;
  language?: string;
  buttonTitle?: string;
  subsribe_to_watch?: boolean;
  isplaylist?: boolean;
  isdownload?: boolean;
  btn_title?: string;
  icon_class?: string;
  ...
  views?: any;
  time?: string;
  cencerratting?: boolean;
  imdbratting?: number;
  lenguagecountry?: string;
  redirectTo?: string;
}

const Details_Part = (props: Props) => {
          ...
          {subsribe_to_watch && (
            <>
              <div className="iq-play-button iq-button">
                <Link
                  href={`${redirectTo ? redirectTo : "/video-player"}`}
                ...
                >
                  <div>
                    <Link
                      ...
                      className="btn btn-secondary border rounded d-flex align-items-center justify-content-center gap-2"
                    >
              ...
              <Modal.Body className="py-0">
                <div className="playlist-modal-content">
                  ...
                  <Form.Check // prettier-ignore
                    type="checkbox"
                    id="drama"
                    label={t("streamGenres.drama")}
                  />

                  <Form.Check // prettier-ignore
                    type="checkbox"
                    id="horror"
                    label={t("streamGenres.horror")}
                  />
                ...
                <div className="copy-link">
                  ...
                  <div className="input-group mb-0">
                    <input
                      ...
                      value="https://templates.iqonic.design/streamit-dist/frontend/html/"
                      aria-label="Username"
                      readOnly
                      ref={inputRef}
                    />
                    ...
                    >
                      <i
                        className={`${
                          Copytext ? "ph ph-check" : "ph ph-copy-simple"
                        }`}
                        id="copyIcon"
                      ></i>
                    </button>
