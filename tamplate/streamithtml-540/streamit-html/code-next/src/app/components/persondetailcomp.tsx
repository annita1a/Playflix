            ...
            <Col md={9} className="mt-5 mt-md-0">
              ...
              <ul className="person-category d-flex flex-wrap align-items-center gap-5 ps-0">
                <li className="list-group-item">
                  <Link href="">{t("persondesc.actor")}</Link>
                </li>
              </ul>
                ...
                <Tab.Container defaultActiveKey="all" transition={true}>
                  ...
                  <Tab.Content className="tab-content personal-detail-tab-content">
                    ...
                    >
                      <div className="description-content">
                        <Row className="gy-5">
                          ...
                          {PersonDetail_all.map((data , index) => {
                            return (
                    ...
                    >
                      <div className="description-content">
                        <Row className="gy-5">
                          {PersonDetail_movies.map((data , index) => {
                            return (
                                <Col xl={4} sm={6} key={index}>
                                  <PersonDetailCard
                                    productlink={data.productlink}
                    ...
                    >
                      <div className="source-list-content">
                        <Row className="gy-5">
                          {PersonDetail_tvshow.map((data , index) => {
                            return (
                                <Col xl={4} sm={6} key={index}>
                                  <PersonDetailCard
                                    productlink={data.productlink}
