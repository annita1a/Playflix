...
const Review_Details = () => {
  ...
  return (
    <>
      <div className="rate-review-details">
        <div className="d-flex align-items-center justify-content-between gap-3 mb-3">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <Link className="btn btn-link p-0 custom-fs-14" href="/view-more">
              View More
            </Link>
          </div>
        </div>
            ...
            <div className="review-detail rounded-3">
              <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div className="d-flex align-items-center justify-content-center gap-3">
                  {/* <!-- Display user avatar --> */}
                  <img
                    src="/assets/images/user/robert.jpg"
                    className="img-fluid user-img rounded-circle"
                    alt="admin"
                  />
      ...
      >
        <Offcanvas.Header
          className="offcanvas-header position-relative border-bottom"
          closeButton
        >
        ...
        <Offcanvas.Body>
          <Form>
            ...
            <div className="form-group">
              <label className="form-label flex-grow-1" htmlFor="Description">
                Your Review
              </label>
              <textarea
                id="Description"
