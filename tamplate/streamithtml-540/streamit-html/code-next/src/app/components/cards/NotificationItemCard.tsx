...
// components/NotificationItemCard.tsx
...
const NotificationItemCard: React.FC<NotificationItemCardProps> = ({ image, title, days }) => {
      ...
      <div className="d-flex align-items-center justify-content-between gap-3">
        ...
        <div className="notification-actions flex-shrink-0">
          <div className="d-flex justify-content-center align-items-center gap-3">
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="tooltip-mark-read">{t("streamAccount.mark_as_read")}</Tooltip>}
            >
              <Button
                type="button"
                variant="secondary"
