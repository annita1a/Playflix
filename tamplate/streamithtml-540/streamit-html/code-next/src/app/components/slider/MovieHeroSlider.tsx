...
const MovieHeroSlider = memo(() => {
  ...
  return (
    <section className="banner-container">
                          ...
                          >
                            <div className="slider-ratting d-flex align-items-center gap-3 flex-wrap mb-3 mb-md-0">
                              ...
                              <div className="font-size-16">
                                ...
                                <span className="trending-time font-normal">{movie.time}</span>
                              </div>
                              <div className="font-size-16">
                                <i className="ph ph-calendar-dots align-middle"></i>{" "}
                                <span className="trending-year font-normal">{movie.year}</span>
                              </div>
                            </div>
      ...
      <FsLightbox toggler={toggler} sources={movieSlides.map(m => m.image)} />
    </section>
  );
});
