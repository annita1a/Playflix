...
// static data
import { videoBanners, generateImgPath } from "../../StaticData/data";
  ...
  return (
    <Fragment>
      <section className="banner-container">
                            ...
                            >
                              <div className="slider-ratting d-flex align-items-center gap-3 flex-wrap mb-3 mb-md-0">
                                ...
                                <div className="d-flex align-items-center gap-1">
                                  <span className="badge bg-secondary"><i className="ph ph-eye"></i> {movie.views}</span>
                                </div>                            
                                ...
                                <div className="font-size-16">
                                  ...
                                  <span className="trending-year font-normal">{movie.release}</span>
                                </div>
                              </div>
        ...
        <FsLightbox toggler={toggler} sources={videoBanners.map(m => m.image)} />
      </section>
