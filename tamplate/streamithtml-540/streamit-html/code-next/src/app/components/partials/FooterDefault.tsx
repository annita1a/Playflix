            ...
            <Container fluid>
              <Row className="gy-4">
                <Col lg={3} sm={6}>
                  ...
                  <Link href="tel:+4805550103" className="helpline">
                    +(480) 555-0103
                  </Link>
                </Col>
                <Col lg={2} sm={6}>
                  ...
                  <ul className="list-unstyled footer-menu mb-0">
                    <li className="">
                      <Link href="/view-all">{t("sectionTitle.top_trending")}</Link>
                    </li>
                    <li className="">
                      <Link href="/view-all">{t("sectionTitle.recommended")}</Link>
                    </li>
                    <li>
                      <Link href="/view-all">{t("sectionTitle.popular")}</Link>
                    </li>
                  </ul>
                </Col>
                <Col lg={2} sm={6}>
                  ...
                  <ul className="list-unstyled footer-menu mb-0">
                    <li className="">
                      <Link href="/extra/contact-us">{t("streamPages.contact_us")}</Link>
                    </li>
                    <li className="">
                      <Link href="/extra/pricing-plan">{t("streamPages.pricing_plan")}</Link>
                    </li>
                    <li className="">
                      <Link href="/blogs">{t("streamPages.blog")}</Link>
                    </li>
                    <li>
                      <Link href="/extra/faq">{t("streamPages.faq")}</Link>
                    </li>
                  </ul>
                </Col>
                <Col lg={2} sm={6}>
                  ...
                  <ul className="list-unstyled footer-menu mb-0">
                    <li className="">
                      <Link href="/extra/about-us">{t("streamPages.about_us")}</Link>
                    </li>
                    <li className="">
                      <Link href="/merchandise/shop">{t("streamPages.shop")}</Link>
                    </li>
                    <li>
                      <Link href="/extra/terms-of-use">
              ...
              <Row className="align-items-center">
                ...
                <Col md={6} className="mt-md-0 mt-5">
                  <div className="d-flex flex-column align-items-start align-items-md-end widget-iq-download-app">
                    <h6 className="mb-3 fw-bold">{t("streamAccount.download_app")}</h6>
                    <div className="d-flex align-items-center">
                      <Link className="app-image" href="#">
                        <img
                          src="/assets/images/footer/play-store.webp"
                          loading="lazy"
                          alt="play-store"
                        />
                      </Link>
