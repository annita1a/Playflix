...
const ShopPage = () => {
    ...
    useBreadcrumb(t("streamShop.product"))
        ...
        <Container fluid>
          <Row>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="iq-custom-select d-inline-block shop-select">
                      {/* <ChoicesJs
                        ...
                        select="one"
                      /> */}
                      <ChoicesJs options={options}></ChoicesJs>
                    </div>
                  </div>
                </div>
                <Tab.Content >
              ...
              <div className="pagination justify-content-center my-5">
                ...
                >
                  <li className="page-item">
                    <Link className="page-link rounded-3" href="#">
            ...
            <Col lg="3">
              <div className="pe-3">
                <ShopCategorySidebar>
                  {newProduct.slice(0, 3).map((item:any, index:number, arr:any) => {
                    const rating = item.ratting || 0; // default to 0 if undefined
                    const fullStars = Math.floor(rating);
                    const hasHalfStar = rating % 1 !== 0;
                    const emptyStars = 5 - fullStars - (hasHalfStar ? 1 : 0);
                    return (
                          <li className={`d-flex align-items-center ${index === arr.length - 1 ? "":"mb-4"}`} key={index}>
