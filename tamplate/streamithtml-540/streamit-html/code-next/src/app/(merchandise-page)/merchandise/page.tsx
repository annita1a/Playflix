          ...
          <Row>
            <Col lg="6" md="6">
              <div className="categorie-about-left">
                <div className="categorie-about-image">
                  <img src="/assets/images/shop/card/capton-america.webp" className="img-fluid" />
                </div>
            ...
            <Col lg="6" md="6">
              <div className="categorie-about-right">
                <div className="categorie-about-image">
                  <img src="/assets/images/shop/card/deadpool.webp" className="img-fluid" />
                </div>
                <div className=" text-left mb-4 pt-3">
                  <h4 className="mb-2 line-count-1">
      ...
      >
        <Container fluid>
          <Row className="row align-items-center">
            <Col md={6} >
              <img src="/assets/images/shop/card/multipal.webp" className="img-fluid" alt="" />
            </Col>
     ...
     <div className="product_container">
        <Row className=" gx-0">
          ...
          <Col lg="6" md="12" className="shop-contact">
            <img src="/assets/images/shop/card/location.webp" alt="" className="img-fluid h-100 w-100" />
          </Col>
        </Row>
      </div>
    </Fragment>
