...
import { ProfilePage_Notificationread, ProfilePage_NotificationUnread, ProfilePage_WatchlistMovie, ProfilePage_WatchlistTvShow, ProfilePage_WatchlistVideo, ProfilPage_PlaylistEpisode, ProfilPage_PlaylistMovie, ProfilPage_PlaylistVideo } from "@/StaticData/data";
...
const ProfilePage = () => {
  ...
  const [firstName, setFirstName] = useState(t("streamProfile.marvin") || "");
  const [LastName, setLastName] = useState(t("streamProfile.mckinney") || "");
  const [email, setEmail] = useState("marvin@demo.com");
                  ...
                  >
                    <div className="play-lists">
                      <Tab.Container defaultActiveKey="movie">
                        <div className="row g-2 column-reverce align-items-center border-bottom playlist-bottom-margin">
                          <Col xs={8} sm={9} lg={10}>
                            <div id="item-nav">
                              <div
                        ...
                        >
                          ...
                          >
                            <Row className="gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 data-listing">
                              {ProfilePage_WatchlistMovie.map((data:any , index:number) => {
                                return (
                                    <Col key={index}>
                                      <WishlistCard
                                        image={data.image}
                          ...
                          >
                            <Row className="gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 data-listing">
                              {ProfilePage_WatchlistVideo.map((data:any , index:number) => {
                                return (
                                    <Col key={index}>
                                      <WishlistCard
                                        image={data.image}
                          ...
                          >
                            <Row className="gy-4 row-cols-2 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 data-listing">
                              {ProfilePage_WatchlistTvShow.map((data:any , index:number) => {
                                return (
                                    <Col key={index}>
                                      <WishlistCard
                                        image={data.image}
                            ...
                            {ProfilePage_NotificationUnread.map(
                              (data:any, index:number) => {
                                ...
                                const translatedTitle = Array.isArray(
                                  ...
                                  ? data.title.map((key:string) => t(key)).join(" ")
                                  : t(data.title);
                            ...
                            <tbody>
                              <tr id="pmpro_table_order-51311C6265">
                                <th
                                  ...
                                  data-title="Date"
                                >
                                  <Link href="/membership/membership-invoice">
                                    February 18, 2025{" "}
                                  </Link>
                                </th>
                                <td
                ...
                <Row>
                  ...
                  <Col sm="6">
                    <Form.Group className="form-group mb-3">
                      <Form.Label htmlFor="first_name">{t("streamAccount.first_name")}</Form.Label>
                      <Form.Control
                        type="text"
                        name="first_name"
                        id="first_name"
                  ...
                  <Col sm="6">
                    <Form.Group className="form-group mb-3">
                      <Form.Label htmlFor="last_name">{t("streamAccount.last_name")}</Form.Label>
                      <Form.Control
                        type="text"
                        name="last_name"
                        id="last_name"
                  ...
                  <Col sm="12">
                    <Form.Group className="form-group mb-0">
                      <Form.Label htmlFor="user_email">{t("streamAccount.email")}</Form.Label>
                      <Form.Control
                        type="email"
                        name="user_email"
                        id="user_email"
