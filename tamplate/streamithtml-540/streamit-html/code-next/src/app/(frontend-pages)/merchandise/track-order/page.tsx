...
const TrackOrderPage = () => {
    ...
    useBreadcrumb(t("streamPages.order_tracking"))
    return (
        <>
            ...
            <Row>
              ...
              <Col sm="12">
                ...
                <div className="bill_section">
                  <address>
                   {t("streamShop.name_ginger")}<br></br>{t("streamShop.company_chase")}<br></br>{t("streamShop.addresses_24white")}
                    {t("streamShop.name_fabien")}<br></br>{t("streamShop.latin_quasi")}<br></br>{t("streamShop.latin_etvol")}<br></br>{t("streamShop.country_india")}<br></br>{t("streamTag.tags_fuga")}<br></br>{t("streamShop.country_virgin")}
