...
const WishlistPage = () => {
    ...
    useBreadcrumb(t("streamPages.wishlist"));
    const swal = () => {
            Swal.fire({
        ...
        <div className="container">
          ...
          <Table className="table cart-table mb-0" responsive>
            ...
            <tbody>
              <tr data-item="list">
                <td>
                  <button className="btn btn-icon btn-danger delete-btn text-end  bg-transparent text-body border-0" onClick={swal}>
                ...
                <td className="product-img">
                  <div className="product-thumbnail">
                    <Link className="mb-2 me-3" href="#">
                      <img className="avatar-80" src="/assets/images/shop/product/01.webp" alt="" />
                    </Link>{" "}
                  </div>
                </td>
                <td>
              ...
              <tr data-item="list">
                ...
                <td className="product-img">
                  <div className="product-thumbnail">
                    <Link className="mb-2 me-3" href="#">
                      <img className="avatar-80" src="/assets/images/shop/product/02.webp" alt="" />
                    </Link>{" "}
                  </div>
                </td>
                <td>
              ...
              <tr data-item="list">
                ...
                <td className="product-img">
                  <div className="product-thumbnail">
                    <Link className="mb-2 me-3" href="">
                      <img className="avatar-80" src="/assets/images/shop/product/03.webp" alt="" />
                    </Link>{" "}
                  </div>
                </td>
                <td>
            ...
            <ul className="list-inline m-0 p-0 d-flex flex-wrap align-items-center gap-3">
              <li className="flex-shrink-0">
                <Link
                  ...
                  className="d-inline-block border-radius rounded-circle bg-primary text-white text-center d-flex align-items-center justify-content-center"
                  target="_blank"
                >
