...
const TemplatePage = memo(() => {
    ...
    useBreadcrumb(t('blogs.scarlett_backlash'))
    return (
        <Fragment>
                                ...
                                <div className='blog-box'>
                                    ...
                                    <div className="d-flex align-items-center justify-content-between gap-2">
                                        <ul className='iq-blog-category-2 m-0  p-0 list-unstyled'>
                                            <li>
                                                <Link href="" className='fw-500 text-capitalize'>{t(blog.categories)}</Link>
                                            </li>
                                        </ul>
                                        <div className='d-flex align-items-center gap-2'>
                                            <span className='font-size-12'>5 {t("streamBlog.min_read")}</span>
                                            <div>
                                                ...
                                                <span className='font-size-12'>{t("streamBlog.comments")}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <h3>{t(blog.title)}</h3>
                                    <div className='iq-author-details d-flex align-items-center justify-content-between gap-2'>
                                        <div className='iq-author-image d-flex align-items-center gap-2'>
                                            ...
                                            <div className='gap-1 d-flex align-items-center font-size-14'>
                                                By <span><Link href="" className='fw-500 text-capitalize'>{t(blog.username)}</Link></span>
                                            </div>
                                        </div>
                                ...
                                <div className='iq-blog-tag'>
                                    <ul className='p-0 m-0 list-unstyled gap-2 widget_tags'>
                                        <li>
                                            ...
                                            <span className="font-size-12 fw-semibold">{t("streamTag.tags")}:</span>
                                        </li>
                                        {blog.tags.map((item: string, index: string) => {
                                            return (
                                                <li key={index}>
                                                    <Link href="" className='text-capitalize'>{t(item)}</Link>
                                                </li>
                                            )
                                        })}
                                    </ul>
