...
final class PseudoLocalizationTranslator implements TranslatorInterface, TranslatorBagInterface
{
     ...
     *      example: if ["title"], and with the "accents" option set to true, "<a href="javascript:void(0)" title="Go to your profile">Profile</a>" => "<a href="javascript:void(0)" title="Ĝö ţö ýöûŕ þŕöƒîļé">Þŕöƒîļé</a>" - if "title" was not in the "localizable_html_attributes" list, the title attribute data would be left unchanged.
     */
