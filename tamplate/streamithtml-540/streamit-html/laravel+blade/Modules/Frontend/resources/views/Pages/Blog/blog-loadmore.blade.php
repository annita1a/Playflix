...
<div class="blog-pagination section-padding">
    <div class="container">
        <div class="row gy-5 row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 data-listing gy-5">
            <div class="col">
        ...
        <div class="text-center mt-4">
            <a href="javascript:void(0)" class="btn btn-primary position-relative custom-button load-more-btn">
