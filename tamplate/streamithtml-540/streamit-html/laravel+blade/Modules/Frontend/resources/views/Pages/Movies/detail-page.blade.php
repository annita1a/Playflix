...
<div class="position-relative">
    <div class="iq-main-slider site-video position-relative">
        <video id="my-video" poster="{{ asset('frontend/images/media/gameofhero.webp') }}"
    ...
    <div class="movie-detail-part position-relative">
        <div class="trending-info pt-0 pb-0">
            <div class="details-parts">
                ...
                'moveName' => __('streamMovies.game_of_heros'),
                'movieType' => 'NC-17',
                'movieDuration' => '2hr : 6mins',
                'movieReleased' => '2021',
                'movieViews' => '284' . __('streamTag.views'),
                'imdbRating' => '7',
                'movieLanguage' => true,
...
<div class="container-fluid">
    <div class="overflow-hidden">
        ...
        'recommended' => __('sectionTitle.movies_recommended'),
        ...
        <div class="related-product-block related-product-slider">
            <section class="overflow-hidden">
                <div class="d-flex align-items-center justify-content-between px-1 mb-2 pb-1 mb-md-4 pb-md-0">
                    <h4 class="main-title text-capitalize mb-0">{{ __('sectionTitle.related_products') }}</h4>
                </div>
                <div class="card-style-slider">
                    <div class="position-relative swiper swiper-card" data-slide="6" data-laptop="6" data-tab="3"
                        data-mobile="2" data-mobile-sm="2" data-autoplay="false" data-loop="false"
