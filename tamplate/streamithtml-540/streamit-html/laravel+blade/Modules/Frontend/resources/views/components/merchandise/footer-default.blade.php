                                ...
                                <ul class="list-unstyled footer-menu mb-0">
                                    <li>
                                        <a href="{{ route('frontend.terms-and-policy') }}"
                                            class="ms-3">{{ __('frontendfooter.terms_and_use') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-md-start text-center">
                    <p class="m-0 font-size-14 text-capitalize">© <span class="currentYear">2023</span><a
                            href="./index.html"> STREAMIT </a> {{__('frontendfooter.all_right_reserved')}}</p>
                </div>
                <div class="col-md-6 text-md-end text-center">
                    <p class="m-0 font-size-14">{{__('frontendfooter.powered_by')}} <a href="https://iqonic.design/" target="_blank">IQONIC
                            DESIGN</a></p>
                </div>
            </div>
        </div>
