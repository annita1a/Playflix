<div class="shop-box">
    <h5 class="widget-title-sidbar">
        <span>{{__('streamShop.product_categories')}}</span>
    </h5>
    ...
    <div class="shop-box">
        <h4 class="title-product-sidbar">{{__('streamShop.price_filter')}} </h4>
        ...
        <div class=" d-flex align-items-center my-3 price-range">
            <small>{{__('streamShop.price_filter')}} :&nbsp;</small>
    ...
    <ul class="list-unstyled p-0 m-0 shop-list-checkbox">
        ...
        <li>
            <div class="form-check d-block">
                ...
                <label class="form-check-label" for="flexCheckDefault6">
                    {{__('streamShop.haunted_halloween')}}
                </label>
            </div>
        </li>
        <li>
            ...
            <div class="collapse" id="categoriestwo">
                <ul class="list-unstyled ps-2 mt-3">
                    <li>
                        <div class="form-check d-block">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault8">
                            <label class="form-check-label" for="flexCheckDefault8">
                                {{__('streamShop.avengers')}}
                            </label>
                        </div>
                    </li>
                    <li>
        ...
        <li>
            ...
            <div class="collapse" id="categoriesthree">
                <ul class="list-unstyled ps-2 mt-3">
                    <li>
                        <div class="form-check d-block">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault11">
                            <label class="form-check-label" for="flexCheckDefault11">
                                {{__('streamShop.ghost_spider')}}
                            </label>
                        </div>
                    </li>
                </ul>
        ...
        <li>
            <div class="form-check d-block">
                ...
                <label class="form-check-label" for="flexCheckDefault18">
                    {{__('streamShop.warner_bros_films')}}
                </label>
            </div>
        </li>
    </ul>
...
<div class="shop-box">
    <h4 class="title-product-sidbar">{{__('streamTag.tags')}} </h4>
    <ul class="iq-blog-meta-cat-tag iq-blogtag p-0 m-0 list-unstyled gap-2 widget_tags widget-tags-product">
        <li>
            <a href="blog-tag" class="position-relative">{{__('streamShop.camera')}}</a>
        </li>
        <li>
            <a href="blog-tag" class="position-relative">{{__('streamShop.costume')}}</a>
        </li>
        <li>
            <a href="blog-tag" class="position-relative">{{__('streamShop.lighting')}}</a>
        </li>
        <li>
            <a href="blog-tag" class="position-relative">{{__('streamShop.production')}}</a>
        </li>
        <li>
            <a href="blog-tag" class="position-relative">{{__('streamShop.studios')}}</a>
        </li>
    </ul>
</div>

<div class="shop-box">
    <h4 class="title-product-sidbar">{{__('streamShop.product_size')}}</h4>
...
<div class="shop-box border-bottom-0">
    <h4 class="title-product-sidbar">{{__('streamShop.product')}}</h4>
    <ul class="list-unstyled m-0 p-0 shop-product">
        <li class="d-flex align-items-center mb-4">
            <div class="top-product-img pe-3">
                <img src="{{asset('frontend/images/shop/product/01.webp')}}" class="img-fluid" alt="img">
            </div>
            <div>
                <a class="fw-medium" href="product-detail">{{__('streamShop.product1')}}</a>
                <p class="mb-0">
                    <del>$48.00</del> $28.00
                </p>
        ...
        <li class="d-flex align-items-center mb-4">
            <div class="top-product-img pe-3">
                <img src="{{asset('frontend/images/shop/product/02.webp')}}" class="img-fluid" alt="img">
            </div>
            <div class="product-detail">
                <a class="fw-medium" href="">{{__('streamShop.product2')}}</a>
                <div>
                    $13.00
                </div>
                <div class="container-rating">
                    <div class="star-rating text-primary">
                        ...
                        <span>
                            <i class="ph-fill ph-star-half text-warning" aria-hidden="true"></i>
                        </span>
        ...
        <li class="d-flex align-items-center">
            <div class="top-product-img pe-3">
                <img src="{{asset('frontend/images/shop/product/03.webp')}}" class="img-fluid" alt="img">
            </div>
            <div class="product-detail">
                <a class="fw-medium" href="">{{__('streamShop.product3')}}</a>
                <p class="mb-0">
                   $18.00 - $45.00
                </p>
                <div class="container-rating">
