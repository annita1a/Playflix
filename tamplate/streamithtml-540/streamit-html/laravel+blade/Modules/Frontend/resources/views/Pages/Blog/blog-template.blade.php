        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="blog-box">
                        <img src="{{ asset('frontend/images/blog/blog2.webp') }}" class="img-fluid mb-4 pb-3 rounded"
                            loading="lazy" id="01" alt="template">
                                ...
                                <div>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            stroke="#E50914" stroke-width="1.3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path d="M10.3637 8.24775H10.3691" stroke="#E50914" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M7.95843 8.24775H7.96383" stroke="#E50914" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M5.55316 8.24775H5.55856" stroke="#E50914" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                        ...
                        <div class="iq-author-details d-flex align-items-center justify-content-between gap-2">
                            <div class="iq-author-image d-flex align-items-center gap-2">
                                <img src="{{ asset('frontend/images/user/user1.webp') }}"
                                    class="img-fluid avatar-40 rounded-circle" alt="user" loading="lazy" />
                            ...
                            <div class="iq-published-date">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2.19336 5.59936H11.8109" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M9.39685 7.70678H9.40185" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M7.00232 7.70678H7.00732" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M4.60291 7.70678H4.6079" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M9.39685 9.80371H9.40185" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M7.00232 9.80371H7.00732" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M4.60291 9.80371H4.6079" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M9.18255 1.60425V3.37991" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path d="M4.82318 1.60425V3.37991" stroke="#E50914" stroke-width="1.5"
                                        stroke-linecap="square"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M11.8571 2.4563H2.14453V12.3959H11.8571V2.4563Z" stroke="#E50914"
                                        stroke-width="1.5" stroke-linecap="square"></path>
                                </svg>
                                <span class="font-size-14 text-uppercase">
                                    <a href="javascript:void(0)">30 Jan 2019</a>
                                </span>
                            </div>
                        </div>
                    </div>
                    <p class="pb-4">{{ __('frontendblogs.integer_volutpat') }}<span
                            class="text-primary fw-bold">{{ __('frontendblogs.rutrum') }}</span>
                    ...
                    <p class="pt-4"> {{ __('frontendblogs.collaboratively_administrate') }} <span
                            class="text-white text-decoration-underline">{{ __('frontendblogs.convergence') }}</span>
                    ...
                    <div class="row my-5">
                        ...
                        <div class="col-lg-10">
                            <div class="position-relative padding-200"
                                style="background-image: url('{{ asset('frontend/images/pages/bg-rectangle.webp') }}'); background-size:cover">
                    ...
                    <ul>
                        <li class="mb-3">{{ __('frontendblogs.mauris') }} <span
                                class="text-white text-capitalize">{{ __('frontendblogs.nunc') }} </span>
                        ...
                        <li>{{ __('frontendblogs.quisque') }}<span class="text-primary fw-bold fst-italic">
                                {{ __('frontendblogs.venenatis_fringilla') }} </span>
                            {{ __('frontendblogs.sem_sceleris') }}
                        </li>
                    </ul>
                    ...
                    <div class="iq-blog-tag">
                        <ul class="p-0 m-0 list-unstyled gap-2 widget_tags">
                            ...
                            <li>
                                <a href="" class="position-relative">{{ __('streamTag.action') }}</a>
                            </li>
                            <li>
                                <a href="" class="position-relative">{{ __('frontendblogs.comedies') }}</a>
                            </li>
                            <li>
                                <a href="" class="position-relative">{{ __('streamTag.comedy') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="widget my-5 my-md-0">
                        <div
                            ...
                            <div class="iq-author-image">
                                <img src="{{ asset('frontend/images/user/user1.webp') }}" class="img-fluid rounded"
                    ...
                    <form>
                        ...
                        <p class="mb-4">{{ __('frontendform.logged_jenny') }} <span
                                class="text-primary">{{ __('frontendform.edit_profile') }}</span>
