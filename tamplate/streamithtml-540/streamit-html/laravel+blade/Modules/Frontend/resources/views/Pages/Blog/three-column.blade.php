@extends('frontend::layouts.master', ['isBreadCrumb' => true, 'title' => __('frontendheader.three_column_blog'), 'isFslightbox' => true])

@section('content')
    <div class="blog-column-pages section-padding">
        <div class="container">
            <div class="row row-cols-xl-3 row-cols-md-3 row-cols-1 gy-5">
                <div class="col">
