@extends('frontend::layouts.master', ['isBreadCrumb' => true, 'title' => __('frontendheader.four_column_blog'), 'isFslightbox' => true])

@section('content')
    <div class="blog-column-pages section-padding">
        <div class="container">
            <div class="row row-cols-lg-4 row-cols-md-4 row-cols- gy-5">
                <div class="col">
