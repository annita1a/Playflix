        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="card bg-dark text-white mb-3">
                    <img src="{{ asset('dashboard/images/page-img/07.jpg') }}" class="card-img" alt="#"
                        loading="lazy">
            ...
            <div class="col-lg-6">
                <div class="card mb-3">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="{{ asset('dashboard/images/page-img/08.jpg') }}" class="card-img" alt="#"
                                loading="lazy">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-lg-6">
                <div class="card mb-3">
                    <div class="row no-gutters flex-row-reverse">
                        <div class="col-md-4">
                            <img src="{{ asset('/dashboard/images/page-img/09.jpg') }}" class="card-img" alt="#"
                                loading="lazy">
                        </div>
                        <div class="col-md-8">
                ...
                <div class="card text-white bg-primary mb-3">
                    <div class="card-body">
                        ...
                        <blockquote class="blockquote mb-0">
                            ...
                            <footer class="blockquote-footer text-white font-size-12">Someone famous in <cite
                                    title="Source Title" class="text-white">Source Title</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="row" data-masonry='{"percentPosition": true }'>
                    <div class="col-sm-6 col-lg-4">
                        <div class="card mb-3">
                            <img src="{{ asset('dashboard/images/page-img/07.jpg') }}" class="card-img-top"
                                alt="#" loading="lazy">
                            <div class="card-body">
