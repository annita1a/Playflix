        ...
        <div class="p-0 container-fluid">
            ...
            <div class="mt-3 container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card text-center">
                            <div class="card-body "> <i class="ri-3x text-primary"><i
                                        class="ph-fill ph-browser text-primary fs-1"></i></i>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center">
                            <div class="card-body "> <i class="ri-3x text-primary"><i class="ph ph-clock text-primary fs-1"></i></i>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center">
                            <div class="card-body "> <i class="ri-3x text-primary"><i
                                        class="ph-fill ph-info text-primary fs-1"></i></i>
