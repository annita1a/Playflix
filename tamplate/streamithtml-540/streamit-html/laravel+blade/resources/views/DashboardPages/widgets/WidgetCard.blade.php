                        ...
                        <div class="d-flex flex-column text-center align-items-center justify-content-between ">
                            ...
                            <div class="card-profile-progress">
                                <div id="circle-progress-1"
                                    ...
                                    data-min-value="0" data-max-value="100" data-value="80" data-type="percent"></div>
                                ...
                                <img src="{{ asset('dashboard/images/avatars/avtar_1.png') }}" alt="User-Profile"
                                    loading="lazy" class="theme-color-purple-img img-fluid rounded-circle card-img">
                                <img src="{{ asset('dashboard/images/avatars/avtar_2.png') }}" alt="User-Profile"
                                    loading="lazy" class="theme-color-blue-img img-fluid rounded-circle card-img">
                                <img src="{{ asset('dashboard/images/avatars/avtar_4.png') }}" alt="User-Profile"
                                    loading="lazy" class="theme-color-green-img img-fluid rounded-circle card-img">
                                <img src="{{ asset('dashboard/images/avatars/avtar_5.png') }}" alt="User-Profile"
                                    loading="lazy" class="theme-color-yellow-img img-fluid rounded-circle card-img">
                                <img src="{{ asset('dashboard/images/avatars/avtar_3.png') }}" alt="User-Profile"
                                    loading="lazy" class="theme-color-pink-img img-fluid rounded-circle card-img">
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="#" class=" ">
                                <svg width="24px" viewBox="0 0 22 5" fill="none"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex  justify-content-start align-items-center mb-3">
                        <div class="pe-3">
                            <img src="{{ asset('dashboard/images/avatars/02.png') }}"
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="pe-3">
                            <img src="{{ asset('dashboard/images/avatars/03.png') }}" loading="lazy"
                                class="rounded-circle bg-soft-primary p-1" width="50" height="50" alt="1">
                        </div>
                        <div>
                    ...
                    <div class="d-flex justify-content-start align-items-center mt-4">
                        <div class="pe-3">
                            <img src="{{ asset('dashboard/images/avatars/04.png') }}" loading="lazy"
                                class="rounded-circle bg-soft-danger p-1" width="50" height="50" alt="1">
                        </div>
                        <div>
                    ...
                    <div class="d-flex justify-content-start align-items-center mt-4">
                        <div class="pe-3">
                            <img src="{{ asset('dashboard/images/avatars/05.png') }}" loading="lazy"
                                class="rounded-circle bg-soft-info p-1" width="50" height="50" alt="1">
                        </div>
                        <div>
                        ...
                        <form class="form" action="#">
                            <div class="input-group mb-0">
                                <input type="text" class="form-control"
                                    placeholder="{{ __('widgets.Recipients_username') }}"
                ...
                <div class="card-body">
                    <ul class="media-story m-0 p-0">
                        <li class="d-flex mb-4 align-items-center active">
                            <img src="{{ asset('dashboard/images/avatars/04.png') }}" alt="story-img" loading="lazy"
                                class="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <img src="{{ asset('dashboard/images/avatars/02.png') }}" alt="story-img" loading="lazy"
                                class="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid">
                            <div class="stories-data ms-3">
                        ...
                        <li class="d-flex align-items-center">
                            <img src="{{ asset('dashboard/images/avatars/03.png') }}" alt="story-img" loading="lazy"
                                class="avatar-50 rounded-circle p-1 bg-soft-primary img-fluid">
                            <div class="stories-data ms-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-card grid-cols-3">
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/gallary/04.png') }}">
                            <img src="{{ asset('dashboard/images/gallary/04.png') }}"
                                class="img-fluid bg-info-subtle rounded w-100" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/author/02.png') }}">
                            <img src="{{ asset('dashboard/images/author/02.png') }}"
                                class="img-fluid bg-primary-subtle rounded w-100" alt="profile-image" loading="lazy">
                        </a>
                        ...
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/icons/02.png') }}">
                            <img src="{{ asset('dashboard/images/author/03.png') }}"
                                class="img-fluid bg-warning-subtle rounded w-100" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/author/06.png') }}">
                            <img src="{{ asset('dashboard/images/author/06.png') }}"
                                class="img-fluid bg-soft-primary rounded w-100" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/gallary/05.png') }}">
                            <img src="{{ asset('dashboard/images/author/05.png') }}"
                                class="img-fluid bg-soft-danger rounded w-100" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/author/04.png') }}">
                            <img src="{{ asset('dashboard/images/author/04.png') }}"
                                class="img-fluid bg-soft-primary rounded w-100" alt="profile-image" loading="lazy">
                        ...
                        <a data-fslightbox="gallery" href="{{ asset('dashboard/images/gallary/01.png') }}">
                            <img src="{{ asset('dashboard/images/gallary/01.png') }}"
                                class="img-fluid bg-soft-success rounded w-100" alt="profile-image" loading="lazy">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-4">
                            <img src="{{ asset('dashboard/images/avatars/01.png') }}" alt="User-Profile" loading="lazy"
                                class="theme-color-default-img  img-fluid avatar-60 rounded-pill me-3">
                            <img src="{{ asset('dashboard/images/avatars/avtar_1.png') }}" alt="User-Profile"
                                loading="lazy" class="theme-color-purple-img img-fluid avatar-60 me-3">
                            <img src="{{ asset('dashboard/images/avatars/avtar_2.png') }}" alt="User-Profile"
                                loading="lazy" class="theme-color-blue-img img-fluid avatar-60 me-3">
                            <img src="{{ asset('dashboard/images/avatars/avtar_4.png') }}" alt="User-Profile"
                                loading="lazy" class="theme-color-green-img img-fluid avatar-60 me-3">
                            <img src="{{ asset('dashboard/images/avatars/avtar_5.png') }}" alt="User-Profile"
                                loading="lazy" class="theme-color-yellow-img img-fluid avatar-60 me-3">
                            <img src="{{ asset('dashboard/images/avatars/avtar_3.png') }}" alt="User-Profile"
                                loading="lazy" class="theme-color-pink-img img-fluid avatar-60 me-3">
                    ...
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-4">
                            <img class="rounded-pill p-1 bg-soft-primary img-fluid avatar-60 me-3"
                                src="{{ asset('dashboard/images/avatars/03.png') }}" alt="avatar" loading="lazy">
                            <div class="media-support-info">
                    ...
                    <ul class="list-inline m-0 p-0">
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-warning rounded-pill"><img
                                    src="{{ asset('dashboard/images/avatars/02.png') }}" alt="story-img" loading="lazy"
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-danger rounded-pill"><img
                                    src="{{ asset('dashboard/images/avatars/03.png') }}" alt="story-img" loading="lazy"
                                    class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-dark rounded-pill"><img
                                    src="{{ asset('dashboard/images/avatars/04.png') }}" alt="story-img" loading="lazy"
                                    class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-primary rounded-pill"><img
                                    src="{{ asset('dashboard/images/avatars/05.png') }}" alt="story-img" loading="lazy"
                                    class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-info rounded-pill"><img
                                    src="{{ asset('dashboard/images/avatars/06.png') }}" alt="story-img" loading="lazy"
                                    class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-soft-warning rounded-pill"><img
                                    src="{{ asset('dashboard/images/avatars/07.png') }}" alt="story-img" loading="lazy"
                                    class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="img-fluid bg-soft-info rounded-pill"><img
                                    src="{{ asset('dashboard/images/avatars/09.png') }}" alt="story-img" loading="lazy"
                                    class="rounded-pill avatar-40"></div>
                            <div class="ms-3 flex-grow-1">
