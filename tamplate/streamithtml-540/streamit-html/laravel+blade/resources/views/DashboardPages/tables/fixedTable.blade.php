                  ...
                  <tbody>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/author/01.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/author/02.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/author/03.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/author/04.png') }}" alt="profile" loading="lazy" />
                      ...
                      <tr>
                        <td>
                            <div class="d-flex align-items-center">
                              <img class="rounded img-fluid avatar-40 me-3 bg-primary-subtle"
                                  src="{{ asset('dashboard/images/author/06.png') }}" alt="profile" loading="lazy" />
