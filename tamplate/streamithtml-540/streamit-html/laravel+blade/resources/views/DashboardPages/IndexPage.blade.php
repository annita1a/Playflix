@extends('layouts.app', ['isBanner' => false, 'isSwiperSlider' => true])
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card iq-card">
                <div
                    class="card-header d-flex justify-content-between gap-3 flex-wrap align-items-center top-rated-slider">
                    <div class="card-title iq-header-title">
                        ...
                        <ul class="swiper-wrapper list-inline p-0 m-0">
                            <li class="iq-rated-box swiper-slide">
                                @include('DashboardPages/partials/TopRatedComponent', [
                                    ...
                                    'toptitle' => __('dashboard.The_Last_Breath'),
                                    'toptext' => __('dashboard.Tv_Show'),
                                    'topview' => '134',
                                    'topdownload' => '30k',
                                ])
                            </li>
                            <li class="iq-rated-box swiper-slide">
                                @include('DashboardPages/partials/TopRatedComponent', [
                                    ...
                                    'toptitle' => __('dashboard.Last_Night'),
                                    'toptext' => __('dashboard.movie'),
                                    'topview' => '133',
                                    'topdownload' => '20k',
                                ])
                            </li>
                            <li class="iq-rated-box swiper-slide">
                                @include('DashboardPages/partials/TopRatedComponent', [
                                    ...
                                    'toptitle' => __('dashboard.Jeon_Woochie'),
                                    'toptext' => __('dashboard.movie'),
                                    'topview' => '222',
                                    'topdownload' => '40k',
                                ])
                            ...
                            <li class="iq-rated-box swiper-slide">
                                @include('DashboardPages/partials/TopRatedComponent', [
                                    ...
                                    'toptitle' => __('dashboard.Dino_Land'),
                                    'toptext' => __('dashboard.Tv_Show'),
                                    'topview' => '122',
                                    'topdownload' => '25k',
                                ])
                            ...
                            <li class="iq-rated-box swiper-slide">
                                @include('DashboardPages/partials/TopRatedComponent', [
                                    ...
                                    'toptitle' => __('dashboard.Last_Race'),
                                    'toptext' => __('dashboard.Tv_Show'),
                                    'topview' => '144',
                                    'topdownload' => '35k',
                                ])
                            ...
                            <li class="iq-rated-box swiper-slide">
                                @include('DashboardPages/partials/TopRatedComponent', [
                                    ...
                                    'toptitle' => __('dashboard.Open_Dead_Shot'),
                                    'toptext' => __('dashboard.Tv_Show'),
                                    'topview' => '134',
                                    'topdownload' => '30k',
                                ])
                            ...
                            <div class="card border-0">
                                <div class="card-body bg-body p-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class=" ">
                                            <p class="mb-0 font-size-14 line-height">{{__('dashboard.existing')}} <br>
            ...
            <div class="card">
                    <div class="card-header d-flex justify-content-between gap-3 flex-wrap align-items-center mb-4 gap-2">
                        <div class="card-title">
                            <h4 class="mb-0 responsive-item-font">{{__('dashboard.Viewed_Items')}}</h4>
                        </div>
                        <div class="card-header-toolbar d-flex align-items-center seasons">
                            <div class="iq-custom-select d-inline-block">
                    ...
                    <div class="card-body">
                        <div class="table-view table-space table-responsive">
                            <table id="seasonTable" class="data-tables table custom-table movie_table data-table-one streamit-wraper-table2" data-toggle="data-table1">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @include('DashboardPages/widgets/RecentlyViewCard', [
                                        'recentlyImg' => 'war-for-the-planet.webp',
                                        'id' => '04',
