                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group input-group custom-input-group">
                                    <span class="input-group-text custom-input-group-text" id="basic-addon1">@</span>
                    ...
                    <form class="was-validated">
                        ...
                        <div class="form-group">
                            <select class="form-select" required aria-label="select example">
                               <option>{{__('form.Open_this_select_menu')}}</option>
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group custom-input-group has-validation">
                                <span class="input-group-text custom-input-group-text" id="inputGroupPrepend">@</span>
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <div class="input-group custom-input-group has-validation">
                                <span class="input-group-text custom-input-group-text" id="validationTooltipUsernamePrepend">@</span>
