        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="form-wizard1" class="mt-3 text-center form-content">
                            ...
                            <fieldset>
                                <div class="form-card text-start">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">{{__('authentication.user-name')}}: *</label>
                                                <input type="text" class="form-control" name="uname"
                                                    placeholder="{{__('authentication.user-name')}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group custom-input-group">
                                                    ...
                                                    <span class="input-group-text custom-input-group-text"><i
                                                            class="ph ph-eye-slash" id="togglePassword"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group custom-input-group">
                                                    ...
                                                    <span class="input-group-text custom-input-group-text"><i
                                                            ...
                                                            id="conform-togglePassword"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <button type="button" name="next"
                                    class="btn btn-primary next action-button float-end" value="Next">{{__('authentication.next')}}</button>
                            </fieldset>
                            <fieldset>
                                <div class="form-card text-start">
                                    <div class="row">
                                        ...
                                        <div class="col-5">
                                            <h2 class="steps text-end fs-5">{{__('authentication.step')}} 2 - 4</h2>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <button type="button" name="previous"
                                    ...
                                    value="Previous">{{__('authentication.previous')}}</button>
                            </fieldset>
                            <fieldset>
                                <div class="form-card text-start">
                                    <div class="row">
                                ...
                                <button type="button" name="next"
                                    class="btn btn-primary next action-button float-end" value="Submit">{{__('form.Submit')}}</button>
                                <button type="button" name="previous"
                                    class="btn btn-dark previous action-button-previous float-end me-1"
                                    value="Previous">{{__('authentication.previous')}}</button>
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-3"> <img
                                                src="{{ asset('dashboard/images/pages/img-success.png') }}"
                                                class="img-fluid" alt="fit-image" loading="lazy"> </div>
                                    </div>
                                    <br><br>
                                    <div class="row justify-content-center">
                                        <div class="text-center col-7">
                                            <h5 class="text-center purple-text">{{ __('form.you_have_successfully') }}
                                            </h5>
                                        </div>
                                    </div>
                                </div>
