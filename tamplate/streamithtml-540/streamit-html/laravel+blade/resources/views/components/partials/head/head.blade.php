...
<link rel="stylesheet" href="{{ asset('dashboard/vendor/phosphor-icons/Fonts/bold/style.css') }}">
<link rel="stylesheet" href="{{ asset('dashboard/vendor/phosphor-icons/Fonts/fill/style.css') }}">
<link rel="stylesheet" href="{{ asset('dashboard/vendor/phosphor-icons/Fonts/duotone/style.css') }}">
