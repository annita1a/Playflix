...
<div class="offcanvas offcanvas-end live-customizer" tabindex="-1" id="live-customizer" data-bs-backdrop="false"
    ...
    <div class="offcanvas-header pb-0 justify-content-between">
        <div class="d-flex align-items-center">
            <h4 class="offcanvas-title" id="live-customizer-label">{{__('dashboard.setting_panel')}}</h4>
        </div>
            ...
            <div class="col-lg-12">
                <div>
                    <div class="text-center mb-4">
                        <h5 class="d-inline-block">{{__('dashboard.style_setting')}}</h5>
                    </div>
                    <div>
                        <!-- Theme start here -->
                        <div class="mb-4">
                            <h5 class="mb-3">{{__('dashboard.theme')}}</h5>
                            <div class=" mb-3" data-setting="radio">
                                <div class="form-check mb-0 w-100">
                                    <input class="form-check-input custom-redio-btn" type="radio" value="light"
                                        name="theme_scheme" id="color-mode-light1" checked="">
                                    <label class="form-check-label d-flex align-items-center justify-content-between"
                                        for="color-mode-light1">
                                        <span>{{__('dashboard.light_theme')}}</span>
                            ...
                            <div class=" mb-3" data-setting="radio">
                                <div class="form-check mb-0 w-100 ">
                                    <input class="form-check-input custom-redio-btn" type="radio" value="dark"
                                        name="theme_scheme" id="color-mode-dark1">
                                    <label class="form-check-label d-flex align-items-center justify-content-between"
                                        for="color-mode-dark1">
                                        <span>{{__('dashboard.dark_theme')}}</span>
                                        <span class="text-primary ">
                                            <svg width="60" height="27" viewBox="0 0 60 27" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.375" y="0.375" width="59.25" height="26.25" rx="4.125"
                            ...
                            <div class="d-flex align-items-center justify-content-between" data-setting="radio">
                                <div class="form-check mb-0 w-100">
                                    <input class="form-check-input custom-redio-btn" type="radio" value="auto"
                                        name="theme_scheme" id="color-mode-auto1">
                                    <label class="form-check-label d-flex align-items-center justify-content-between"
                                        for="color-mode-auto1">
                                        <span>{{__('dashboard.device_default')}}</span>
                                        <span class="text-primary ">
                        ...
                        <!-- Menu start here -->
                        <div>
                            <h6 class="mt-4 mb-3">{{__('dashboard.menu_color')}}</h6>
                        ...
                        <div>
                            <h5 class="mt-4 mb-3">{{__('dashboard.menu_style')}}</h5>
                        ...
                        <div class="mb-4">
                            <h5 class="mt-4 mb-3">{{__('dashboard.active_menu_style')}}</h5>
                        ...
                        <div>
                            <div class="d-flex align-items-center justify-content-between">
                                <h6 class="mt-4 mb-3">{{__('dashboard.color_customizer')}}</h6>
                                <div class="d-flex align-items-center">
                                    <a href="#custom-color" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="custom-color">{{__('dashboard.custom')}}</a>
                                    <div data-setting="radio">
                        ...
                        <hr class="hr-horizontal">
                        <div>
                            <h6 class="d-inline-block mb-3 me-2">{{__('dashboard.page_style')}} </h6>
                            <div class="d-grid gap-3 grid-cols-2 mb-4">
                                <div data-setting="radio">
                                    <input type="radio" value="container" class="btn-check" name="page_layout"
                                        id="page-layout-boxed">
                                    <label class="btn btn-border d-block" for="page-layout-boxed">{{__('dashboard.boxed')}}</label>
                                </div>
                                <div data-setting="radio">
                                    <input type="radio" value="container-fluid" class="btn-check" name="page_layout"
                                        id="page-layout-full-width" checked="">
                                    <label class="btn btn-border d-block" for="page-layout-full-width">{{__('dashboard.full_width')}}</label>
                                </div>
                            </div>
                        </div>
                        <hr class="hr-horizontal">
                        ...
                        <div>
                            <h5 class="mb-3 mt-4">{{__('dashboard.direction')}}</h5>
                            <div class=" mb-3" data-setting="radio">
                                <div class="form-check mb-0 w-100">
                                    <input class="form-check-input custom-redio-btn" type="radio" value="ltr"
                                        name="theme_scheme_direction" data-prop="dir" id="theme-scheme-direction-ltr1"
                                        checked="">
                                    <label class="form-check-label d-flex align-items-center justify-content-between"
                                        for="theme-scheme-direction-ltr1">
                                        <span>{{__('dashboard.LTR')}}</span>
                            ...
                            <div class="mb-3" data-setting="radio">
                                <div class="form-check mb-0 w-100">
                                    <input class="form-check-input custom-redio-btn" type="radio" value="rtl"
                                        name="theme_scheme_direction" data-prop="dir" id="theme-scheme-direction-rtl1">
                                    <label class="form-check-label d-flex align-items-center justify-content-between "
                                        for="theme-scheme-direction-rtl1">
                                        <span>{{__('dashboard.RTL')}}</span>
                                        <svg class="text-primary" width="60" height="27" viewBox="0 0 60 27" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
