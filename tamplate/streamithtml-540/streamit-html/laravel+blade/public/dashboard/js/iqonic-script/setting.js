...
(function (window) {
  ...
  this.IQSetting = function (opt) {
    ...
    try {
      if (window.IQ_SERVER_DIR) {
        // force the in-memory options setting for direction to server value
        if (this.options && this.options.setting && this.options.setting.theme_scheme_direction) {
          this.options.setting.theme_scheme_direction.value = window.IQ_SERVER_DIR;
        }
      }
    } catch (e) {
      // ignore
